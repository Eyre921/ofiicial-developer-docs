...
source: https://docs.trychroma.com/docs/collections/conditional-transactions
path: docs/collections/conditional-transactions
---

Use optimistic, collection-scoped transactions for read-check-write workflows.
