...
<CardGroup>
  ...
  <Card href="/integrations/n8n">
    ...
    <span>Frameworks</span>
    <h2>n8n</h2>
    <p>Build AI workflows with the Pinecone Assistant or Vector Store node—managed RAG or full control over your pipeline.</p>
  </Card>
