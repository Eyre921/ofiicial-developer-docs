---
title: "Pinecone Marketplace 2026 release notes"
source: https://docs.pinecone.io/marketplace-release-notes/2026
path: marketplace-release-notes/2026
---

Release notes for 2026 from the Pinecone Marketplace docs, covering feature launches, billing updates, and changes across Pinecone products.
...
<Update label="2026-08-06">
  ...
  Pinecone Nexus, the knowledge engine for agents, is now [generally available](/nexus-release-notes/feature-availability). Point Nexus at your sources, curate them into a context, and query that context to get grounded, cited answers. Get started in the [Nexus quickstart](/guides/nexus/quickstart).
</Update>
...
<Update label="2026-05-05">
  ...
  [Pinecone Marketplace](/guides/marketplace/overview) is now in [public preview](/marketplace-release-notes/feature-availability). Marketplace lets you build, publish, and operate AI-powered knowledge applications on top of Pinecone, with a managed deployment lifecycle and end-user chat interface.
