---
title: "Pinecone Assistant 2024 release notes"
source: https://docs.pinecone.io/assistant-release-notes/2024
path: assistant-release-notes/2024
---

Release notes for 2024 from the Pinecone Assistant docs, covering assistant API launches, new features, improvements, and API changes.
...
<Update label="2024-09-18">
  Added the `metrics_alignment` operation, which provides a way to [evaluate the correctness and completeness of a response](/guides/assistant/evaluate-answers) from a RAG system. This feature is in [public preview](/assistant-release-notes/feature-availability).
...
<Update label="2024-08-15">
  [Pinecone Assistant](/guides/assistant/overview) is now in [public preview](/assistant-release-notes/feature-availability).
</Update>
