...
<Note>
  Scheduled backups require [API version](/reference/api/versioning) `2026-04` or later.
</Note>
...
* [Create backup schedule](/reference/api/latest/control-plane/create_backup_schedule)
* [List backup schedules](/reference/api/latest/control-plane/list_backup_schedules)
* [Describe backup schedule](/reference/api/latest/control-plane/describe_backup_schedule)
* [Update backup schedule](/reference/api/latest/control-plane/update_backup_schedule)
* [Delete backup schedule](/reference/api/latest/control-plane/delete_backup_schedule)
* [List schedule history](/reference/api/latest/control-plane/list_backup_schedule_history)
