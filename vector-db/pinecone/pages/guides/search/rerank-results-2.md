...
<AccordionGroup>
  <Accordion title="cohere-rerank-4-fast">
    <PaidOnly />
  ...
  <Accordion title="pinecone-rerank-v0">
    ...
    [`pinecone-rerank-v0`](/models/pinecone-rerank-v0) is a reranking model that can handle chunks up to 512 tokens (1-2 paragraphs).
