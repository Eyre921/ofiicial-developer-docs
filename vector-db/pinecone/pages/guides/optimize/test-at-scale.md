---
title: "Test Pinecone at scale"
source: https://docs.pinecone.io/guides/optimize/test-at-scale
path: guides/optimize/test-at-scale
---
...
<Note>
  This test requires a Pinecone account on the Standard or Enterprise plan because it uses [import from object storage](/guides/index-data/import-data), which isn't available on the Starter or Builder plans. New users can sign up for the [Standard trial](/guides/organizations/manage-billing/standard-trial) for 21 days and \$300 in credits, more than enough to cover the costs of this test. Existing users on the Starter or Builder plan can activate the trial or [upgrade](/guides/organizations/manage-billing/upgrade-billing-plan).
</Note>
