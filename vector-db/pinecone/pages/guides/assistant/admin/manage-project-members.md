...
<Note>
  Project owners can add existing organization members to a project and manage their project roles. Only [organization owners](/guides/assistant/admin/organizations-overview#organization-roles) can invite people who aren't yet members of the organization.
</Note>
