...
path: guides/assistant/admin/manage-api-keys
---
...
You can [view the API keys](/reference/api/latest/admin-assistant/list_api_keys) for your project:
...
You can [view the details of an API key](/reference/api/latest/admin-assistant/fetch_api_key):
