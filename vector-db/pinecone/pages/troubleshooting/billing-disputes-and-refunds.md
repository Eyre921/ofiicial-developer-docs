...
As a rule, Pinecone doesn't offer refunds for unused indexes. If you use a pod-based index, we charge only for the pods you use to create it, not per API call or query. Whether you have used your index or not doesn't factor into our billing.
...
* [Account deactivation for non-payment](/guides/organizations/manage-billing/non-payment-account-deactivation)
