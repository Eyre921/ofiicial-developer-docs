...
source: https://docs.x.com/pt/make-your-first-request
path: pt/make-your-first-request
---

Envie sua primeira solicitação à X API v2 em minutos usando cURL ou Postman, incluindo autenticação, escolha de endpoint e leitura da resposta em JSON.
