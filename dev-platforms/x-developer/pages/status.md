...
source: https://docs.x.com/status
path: status
---

Live status of the X API v2, Enterprise APIs, Ads API, streaming endpoints, and all supporting services. Includes current incidents and historical uptime.
