...
path: es/enterprise-api/getting-started/about-x-api
---

Descripción general de la Enterprise API de X, que incluye acceso completo al firehose, volume y likes streams, webhooks de account activity, límites de tasa personalizados y soporte.
