---
title: "最初のリクエストを送信する"
source: https://docs.x.com/ja/make-your-first-request
path: ja/make-your-first-request
---

cURL や Postman を使用して、認証、エンドポイントの選択、JSON レスポンスの解析を含めて、数分で最初の X API v2 リクエストを送信します。
