---
title: "ステップバイステップガイド"
source: https://docs.x.com/ja/x-ads-api/getting-started/step-by-step-guide
path: ja/x-ads-api/getting-started/step-by-step-guide
---

X Ads API を使い始めるためのステップバイステップガイドです。開発者アカウントの登録、アプリ作成、API キーとアクセストークンの管理、Ads API アクセスの申請、OAuth 認証のセットアップ、最初のリクエスト送信までの手順を順を追って解説します。
