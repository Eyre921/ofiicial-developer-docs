...
path: ja/enterprise-api/getting-started/about-x-api
---

X Enterprise API の概要。完全な firehose アクセス、ボリュームストリームおよびいいねストリーム、Account Activity Webhook、カスタムレート制限、サポートを含みます。
