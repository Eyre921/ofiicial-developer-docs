---
title: "X ID"
source: https://docs.x.com/ja/fundamentals/x-ids
path: ja/fundamentals/x-ids
---

X API における Post およびユーザーの 64 ビット Snowflake ID について、形式、順序、ID インフレーション、JavaScript クライアントでの安全な処理を含めて理解します。
