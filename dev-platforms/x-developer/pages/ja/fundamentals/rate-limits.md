---
title: "レート制限"
source: https://docs.x.com/ja/fundamentals/rate-limits
path: ja/fundamentals/rate-limits
---

アクセスティアおよびエンドポイントごとの X API レート制限について、アプリレベル vs ユーザーレベルの制限、レスポンスヘッダー、再試行のベストプラクティスを含めて理解します。
