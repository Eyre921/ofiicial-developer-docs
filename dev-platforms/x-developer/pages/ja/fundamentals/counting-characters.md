---
title: "文字数のカウント"
source: https://docs.x.com/ja/fundamentals/counting-characters
path: ja/fundamentals/counting-characters
---

X が投稿の文字数をどのようにカウントするか。280 文字制限、加重されたコードポイント、URL の短縮、絵文字と Unicode の取り扱い、エッジケースを含みます。
