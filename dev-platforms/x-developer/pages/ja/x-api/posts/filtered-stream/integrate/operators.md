...
path: ja/x-api/posts/filtered-stream/integrate/operators
---

X API v2 Filtered Stream のオペレーター完全リファレンス。ストリームルール向けの keyword、has:、is:、および Enterprise 限定のセマンティック embedding: オペレーターを網羅します。
