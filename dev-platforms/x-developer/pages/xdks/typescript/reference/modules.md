...
source: https://docs.x.com/xdks/typescript/reference/modules
path: xdks/typescript/reference/modules
---

Reference for the modules module in the X API TypeScript SDK. Re-exported clients, types, and utilities provided by this SDK module for the X API v2.
