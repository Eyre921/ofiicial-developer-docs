...
source: https://docs.x.com/xdks/typescript/reference/classes/ActivityClient
path: xdks/typescript/reference/classes/activityclient
---

Reference for the ActivityClient class in the X API TypeScript SDK. Methods, parameters, and return types for the X API v2 activity endpoints.
