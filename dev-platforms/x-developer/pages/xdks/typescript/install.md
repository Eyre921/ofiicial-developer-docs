---
title: "Installation"
source: https://docs.x.com/xdks/typescript/install
path: xdks/typescript/install
---

Get started with the TypeScript SDK for X API in your project. The SDK is written in TypeScript and includes full type definitions.
