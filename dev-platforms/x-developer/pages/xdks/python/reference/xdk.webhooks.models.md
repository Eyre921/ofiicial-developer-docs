...
source: https://docs.x.com/xdks/python/reference/xdk.webhooks.models
path: xdks/python/reference/xdk.webhooks.models
---

Reference for the webhooks.models Python module in the X API SDK. Pydantic request and response models for the webhooks endpoints of the X API v2.
