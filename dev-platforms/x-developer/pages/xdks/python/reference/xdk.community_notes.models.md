...
source: https://docs.x.com/xdks/python/reference/xdk.community_notes.models
path: xdks/python/reference/xdk.community_notes.models
---

Reference for the community_notes.models Python module in the X API SDK. Pydantic request and response models for the community notes endpoints of the X API.
