---
title: "PostsClient"
source: https://docs.x.com/xdks/python/reference/xdk.posts
path: xdks/python/reference/xdk.posts
---

Reference for the posts Python package in the X API SDK, grouping the client and Pydantic models for the posts endpoints of the X API v2.
