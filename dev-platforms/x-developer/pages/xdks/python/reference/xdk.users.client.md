---
title: "UsersClient"
source: https://docs.x.com/xdks/python/reference/xdk.users.client
path: xdks/python/reference/xdk.users.client
---

Reference for the users.client Python module in the X API SDK. Client class and methods for calling the users endpoints of the X API v2.
...
<ParamField type="CreateBookmarkRequest">
  Request body
</ParamField>
...
<ParamField type="FollowListRequest">
  Request body
</ParamField>
...
<ParamField type="FollowUserRequest">
  Request body
</ParamField>
...
<ParamField type="LikePostRequest">
  Request body
</ParamField>
...
<ParamField type="MuteUserRequest">
  Request body
</ParamField>
...
<ParamField type="PinListRequest">
  Request body
</ParamField>
...
<ParamField type="RepostPostRequest">
  Request body
</ParamField>
