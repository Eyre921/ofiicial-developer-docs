...
source: https://docs.x.com/x-api/lists/manage-lists/integrate
path: x-api/lists/manage-lists/integrate
---

This page covers tools and key concepts for integrating the Lists endpoints. Reference for the X API v2 standard tier covering manage lists.
