...
source: https://docs.x.com/x-api/lists/list-tweets/migrate/overview
path: x-api/lists/list-tweets/migrate/overview
---

Compare Standard v1.1 lists/statuses with the X API v2 List Posts endpoint, including parameters, authentication, and pagination differences.
