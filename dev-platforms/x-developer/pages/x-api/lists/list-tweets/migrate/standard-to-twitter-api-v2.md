---
title: "v1 to v2"
source: https://docs.x.com/x-api/lists/list-tweets/migrate/standard-to-twitter-api-v2
path: x-api/lists/list-tweets/migrate/standard-to-twitter-api-v2
---

If you have been working with the standard v1.1 GET lists/statuses endpoint, the goal of this. Reference for the X API v2 standard tier covering migrate.
