...
source: https://docs.x.com/x-api/lists/pinned-lists/integrate
path: x-api/lists/pinned-lists/integrate
---

This page covers tools and key concepts for integrating the pinned Lists endpoints. Reference for the X API v2 standard tier covering pinned lists.
