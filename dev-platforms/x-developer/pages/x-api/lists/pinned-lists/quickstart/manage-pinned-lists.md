...
source: https://docs.x.com/x-api/lists/pinned-lists/quickstart/manage-pinned-lists
path: x-api/lists/pinned-lists/quickstart/manage-pinned-lists
---

Quickstart for pinning and unpinning X Lists on the authenticated user account using the X API v2 pinned Lists endpoints, with example requests.
...
<CardGroup>
  ...
  <Card title="API Reference" icon="https://mintcdn.com/x-preview/ygI6sSJPehlc0qNT/icons/xds/icon-code.svg?fit=max&auto=format&n=ygI6sSJPehlc0qNT&q=85&s=488e23401b19225b89acc0136d242219" href="/x-api/lists/pin-list">
