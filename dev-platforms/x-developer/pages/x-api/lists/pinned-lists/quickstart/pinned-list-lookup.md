...
source: https://docs.x.com/x-api/lists/pinned-lists/quickstart/pinned-list-lookup
path: x-api/lists/pinned-lists/quickstart/pinned-list-lookup
---

Quickstart for retrieving a user's pinned X Lists using the X API v2 pinned Lists lookup endpoint, including authentication and sample responses.
