...
source: https://docs.x.com/x-api/lists/list-lookup/migrate/standard-to-twitter-api-v2
path: x-api/lists/list-lookup/migrate/standard-to-twitter-api-v2
---

Step-by-step comparison of Standard v1.1 List lookup endpoints and the X API v2 equivalents, including parameters, authentication, and rate limits.
