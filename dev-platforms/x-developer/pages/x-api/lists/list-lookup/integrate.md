...
source: https://docs.x.com/x-api/lists/list-lookup/integrate
path: x-api/lists/list-lookup/integrate
---

This guide covers the key concepts you need to integrate the List lookup endpoints into your. Reference for the X API v2 standard tier covering list lookup.
