...
path: x-api/media/quickstart/best-practices
---

Important concepts and best practices for using the POST /2/media/upload endpoint. Reference for the X API v2 standard tier covering quickstart.
