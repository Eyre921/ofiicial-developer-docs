...
source: https://docs.x.com/x-api/community-notes/introduction
path: x-api/community-notes/introduction
---

Overview of the X API v2 Community Notes endpoints for searching eligible Posts and programmatically submitting Community Note proposals from your app.
