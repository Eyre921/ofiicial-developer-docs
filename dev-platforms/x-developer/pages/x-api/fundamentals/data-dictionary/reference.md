...
source: https://docs.x.com/x-api/fundamentals/data-dictionary/reference
path: x-api/fundamentals/data-dictionary/reference
---

Full X API v2 data dictionary reference covering Tweet, User, Media, Place, Poll, and Space object fields and how to request them with expansions.
