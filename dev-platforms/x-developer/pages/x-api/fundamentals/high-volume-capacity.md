...
source: https://docs.x.com/x-api/fundamentals/high-volume-capacity
path: x-api/fundamentals/high-volume-capacity
---

Learn how to prepare for high-volume events when using X streaming endpoints including Filtered Stream, Volume Streams, Powerstream, and Compliance Streams.
