...
source: https://docs.x.com/x-api/fundamentals/recovery-and-redundancy
path: x-api/fundamentals/recovery-and-redundancy
---

Maximize uptime on X streaming endpoints with redundant connections, automatic reconnects, and backfill or Replay to recover missed Posts and data.
