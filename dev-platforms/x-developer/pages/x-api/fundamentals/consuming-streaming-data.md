...
source: https://docs.x.com/x-api/fundamentals/consuming-streaming-data
path: x-api/fundamentals/consuming-streaming-data
---

Learn how to build robust clients that consume data from X streaming endpoints. X streaming endpoints are categorized by volume: X API streaming endpoints.
