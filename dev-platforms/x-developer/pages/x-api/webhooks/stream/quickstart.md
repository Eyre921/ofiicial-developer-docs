---
title: "Quickstart"
source: https://docs.x.com/x-api/webhooks/stream/quickstart
path: x-api/webhooks/stream/quickstart
---

The v2 filtered stream webhooks API is similar to the [v2 filtered stream. Reference for the X API v2 standard tier covering stream.
