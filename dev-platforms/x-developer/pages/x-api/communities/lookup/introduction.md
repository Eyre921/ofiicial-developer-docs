...
source: https://docs.x.com/x-api/communities/lookup/introduction
path: x-api/communities/lookup/introduction
---

The Communities lookup endpoint lets you retrieve information about X Communities by their ID. Reference for the X API v2 standard tier covering lookup.
