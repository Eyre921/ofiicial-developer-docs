...
source: https://docs.x.com/x-api/communities/search/introduction
path: x-api/communities/search/introduction
---

The Communities Search endpoint lets you search for Communities by keyword. Reference for the X API v2 standard tier covering search.
