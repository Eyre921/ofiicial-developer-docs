...
source: https://docs.x.com/x-api/direct-messages/blocks/introduction
path: x-api/direct-messages/blocks/introduction
---

Use the X API v2 Manage DM blocks endpoints to block or unblock a specified account on behalf of an authenticated user and control who can send Direct Messages.
