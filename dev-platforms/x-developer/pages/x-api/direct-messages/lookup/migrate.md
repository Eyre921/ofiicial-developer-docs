...
source: https://docs.x.com/x-api/direct-messages/lookup/migrate
path: x-api/direct-messages/lookup/migrate
---

Guide to migrating Direct Message lookup code from X API v1.1 to v2, covering endpoint changes, request parameters, and new response payloads.
