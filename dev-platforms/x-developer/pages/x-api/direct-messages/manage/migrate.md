...
source: https://docs.x.com/x-api/direct-messages/manage/migrate
path: x-api/direct-messages/manage/migrate
---

Both v1.1 and v2 versions of the Direct Messages endpoints provide methods for creating Direct. Reference for the X API v2 standard tier covering manage.
...
| Endpoint root path                                                                                                                                                          | [/1.1/direct\_messages](https://api.x.com/1.1/direct_messages)                 | [/2/dm\_conversations](https://api.x.com/2/users/:id/dm_conversations)<br /><br />Direct Messages conversations are introduced as a fundamental API object.   <br /><br />These endpoints retrieve MessageCreate, ParticipantsJoin, and ParticipantLeave events. |
...
| Default request [rate limits](/x-api/fundamentals/rate-limits) |                   | 200 requests per 15 minutes per user<br /><br />1000 requests per user per 24 hours<br /><br />15000 requests per app per 24 hours<br /><br />These rate limits are shared across all dm\_conversations POST endpoints. |
| Supports group Direct Messages                                 |                   | ✔                                                                                                                                                                                                                       |
