...
source: https://docs.x.com/x-api/news/introduction
path: x-api/news/introduction
---

Look up breaking news stories and headlines on X with the v2 news endpoint, including summaries, hooks, contexts, tickers, and clustered Post results.
