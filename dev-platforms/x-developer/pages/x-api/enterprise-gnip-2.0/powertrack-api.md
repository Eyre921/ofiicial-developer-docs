...
source: https://docs.x.com/x-api/enterprise-gnip-2.0/powertrack-api
path: x-api/enterprise-gnip-2.0/powertrack-api
---

This endpoint has been updated to include Post edit metadata. Learn more about this metadata on the "Edit Posts" fundamentals page.
...
*You can view all of the X API filtered stream offerings [HERE](/x-api/posts/filtered-stream).*
