---
title: "Edit Tweets"
source: https://docs.x.com/x-api/enterprise-gnip-2.0/fundamentals/edit-tweets
path: x-api/enterprise-gnip-2.0/fundamentals/edit-tweets
---

Understand enterprise Post edit metadata, including edit_history, edit_controls, and editable fields returned in Gnip and enterprise API payloads.
...
* **edit\_history**  - Provides all Post IDs associated with the edit history of the Post. The "initial\_tweet\_id" attribute indicates the original Post and the "edit\_tweet\_ids" attribute is an array that provides all IDs associated with its edit history. If the Post has not been edited, this array will contain a single ID.
