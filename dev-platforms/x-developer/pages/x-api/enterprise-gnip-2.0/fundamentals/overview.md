---
title: "Gnip console"
source: https://docs.x.com/x-api/enterprise-gnip-2.0/fundamentals/overview
path: x-api/enterprise-gnip-2.0/fundamentals/overview
---

Overview of the enterprise Gnip console at console.gnip.com for managing enterprise X API access, product details, usage metrics, and account settings.
...
View details about your individual user profile, and change your password here. Additionally, you may configure account usage threshold notices specific to your account.  API status notices are available through the status page at [https://api.twitterstat.us](https://api.twitterstat.us).
