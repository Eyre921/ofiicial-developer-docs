...
source: https://docs.x.com/x-api/enterprise-gnip-2.0/fundamentals/rules-filtering
path: x-api/enterprise-gnip-2.0/fundamentals/rules-filtering
---

Build enterprise PowerTrack and Search rules using keyword, phrase, proximity, and boolean operators with grouping for precise X data filtering.
