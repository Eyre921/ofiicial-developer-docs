---
title: "Usage API"
source: https://docs.x.com/x-api/enterprise-gnip-2.0/fundamentals/usage
path: x-api/enterprise-gnip-2.0/fundamentals/usage
---
...
| Method                                        | Description         |
| :-------------------------------------------- | :------------------ |
| [GET /metrics/usage/accounts/.json](#GETData) | Retrieve usage data |
...
[https://gnip-api.x.com/metrics/usage/accounts/:account\\\_name.json](https://gnip-api.x.com/metrics/usage/accounts/:account\\_name.json)
...
curl -u "[https://gnip-api.x.com/metrics/usage/accounts/:account\\\_name.json?bucket=month\&fromdate=201403010000\&toDate=201403150000](https://gnip-api.x.com/metrics/usage/accounts/:account\\_name.json?bucket=month\&fromdate=201403010000\&toDate=201403150000)"
