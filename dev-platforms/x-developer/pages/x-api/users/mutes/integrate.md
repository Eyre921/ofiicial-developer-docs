...
source: https://docs.x.com/x-api/users/mutes/integrate
path: x-api/users/mutes/integrate
---

This guide covers the key concepts you need to integrate the mutes endpoints into your application. Reference for the X API v2 standard tier covering mutes.
