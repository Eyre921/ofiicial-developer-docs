---
title: "Mutes lookup"
source: https://docs.x.com/x-api/users/mutes/migrate/mutes-lookup-standard-to-twitter-api-v2
path: x-api/users/mutes/migrate/mutes-lookup-standard-to-twitter-api-v2
---

If you have been working with the standard v1.1 GET mutes/users/ids and GET mutes/users/list. Reference for the X API v2 standard tier covering migrate.
