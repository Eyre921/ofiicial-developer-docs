---
title: "v1 to v2"
source: https://docs.x.com/x-api/users/follows/migrate/standard-to-twitter-api-v2
path: x-api/users/follows/migrate/standard-to-twitter-api-v2
---

If you have been working with the standard v1.1 POST friendships/create and POST. Reference for the X API v2 standard tier covering migrate.
