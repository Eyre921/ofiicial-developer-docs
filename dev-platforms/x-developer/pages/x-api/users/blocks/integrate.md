...
source: https://docs.x.com/x-api/users/blocks/integrate
path: x-api/users/blocks/integrate
---
...
| :----- | :-------------------------------------------------- | :--------------------------- | :------------------------------------------------------------- |
| GET    | `/2/users/:id/blocking`                             | Get list of blocked accounts | <div><Badge>Pay-per-use</Badge><Badge>Enterprise</Badge></div> |
| POST   | `/2/users/:id/blocking`                             | Block an account             | <Badge>Enterprise</Badge>                                      |
| DELETE | `/2/users/:source_user_id/blocking/:target_user_id` | Unblock an account           | <Badge>Enterprise</Badge>                                      |
