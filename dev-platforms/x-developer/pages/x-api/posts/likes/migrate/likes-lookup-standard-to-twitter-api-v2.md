---
title: "Likes lookup"
source: https://docs.x.com/x-api/posts/likes/migrate/likes-lookup-standard-to-twitter-api-v2
path: x-api/posts/likes/migrate/likes-lookup-standard-to-twitter-api-v2
---

If you have been working with the standard v1.1 GET favorites/list endpoint, the goal of this. Reference for the X API v2 standard tier covering migrate.
