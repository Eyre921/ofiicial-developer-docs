...
source: https://docs.x.com/x-api/posts/manage-tweets/integrate
path: x-api/posts/manage-tweets/integrate
---

This page covers tools and key concepts for integrating the manage Posts endpoints into. Reference for the X API v2 standard tier covering manage tweets.
