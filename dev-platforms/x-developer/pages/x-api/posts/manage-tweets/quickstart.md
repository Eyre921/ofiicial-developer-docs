...
path: x-api/posts/manage-tweets/quickstart
---

Step-by-step quickstart for creating and deleting Posts with the X API v2 standard tier, including authentication, request payloads, and examples.
