---
title: "v1 to v2"
source: https://docs.x.com/x-api/posts/search/migrate/standard-to-twitter-api-v2
path: x-api/posts/search/migrate/standard-to-twitter-api-v2
---

If you have been working with the v1.1 search/posts, the goal of this guide is to help you. Reference for the X API v2 standard tier covering migrate.
