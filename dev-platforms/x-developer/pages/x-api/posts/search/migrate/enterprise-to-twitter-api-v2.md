...
source: https://docs.x.com/x-api/posts/search/migrate/enterprise-to-twitter-api-v2
path: x-api/posts/search/migrate/enterprise-to-twitter-api-v2
---

Migrate from the Enterprise Search Posts API to X API v2 with a side-by-side comparison of pagination, timezones, Post edit history, and metadata fields.
