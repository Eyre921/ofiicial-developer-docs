...
source: https://docs.x.com/x-api/posts/counts/migrate/enterprise-to-twitter-api-v2
path: x-api/posts/counts/migrate/enterprise-to-twitter-api-v2
---

Granularity Pagination Timezone Endpoint URLs App and Project requirement Available time periods. Reference for the X API v2 standard tier covering migrate.
