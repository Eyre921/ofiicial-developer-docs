---
title: "Build a query"
source: https://docs.x.com/x-api/posts/counts/integrate/build-a-query
path: x-api/posts/counts/integrate/build-a-query
---

Your queries will be limited depending on which access level you are using. Reference for the X API v2 standard tier covering integrate.
