---
title: "Overview"
source: https://docs.x.com/x-api/posts/counts/integrate/overview
path: x-api/posts/counts/integrate/overview
---

This page covers tools and key concepts for integrating the Post counts endpoints. Reference for the X API v2 standard tier covering integrate.
