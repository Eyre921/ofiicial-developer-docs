...
source: https://docs.x.com/x-api/posts/retweets/integrate
path: x-api/posts/retweets/integrate
---

This page covers tools and key concepts for integrating the Retweet endpoints. Reference for the X API v2 standard tier covering retweets.
