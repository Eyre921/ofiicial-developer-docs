...
source: https://docs.x.com/x-api/posts/filtered-stream/migrate/powertrack-api-migration-to-twitter-api-v2
path: x-api/posts/filtered-stream/migrate/powertrack-api-migration-to-twitter-api-v2
---

Use this migration guide to understand the similarities and differences between PowerTrack API. Reference for the X API v2 standard tier covering migrate.
