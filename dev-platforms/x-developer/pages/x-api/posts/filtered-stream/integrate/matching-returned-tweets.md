...
source: https://docs.x.com/x-api/posts/filtered-stream/integrate/matching-returned-tweets
path: x-api/posts/filtered-stream/integrate/matching-returned-tweets
---

Use the matching_rules payload field to identify which X API v2 Filtered Stream rules a delivered Post matched, including tags and embedding scores.
