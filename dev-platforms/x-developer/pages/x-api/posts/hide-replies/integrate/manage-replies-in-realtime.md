...
source: https://docs.x.com/x-api/posts/hide-replies/integrate/manage-replies-in-realtime
path: x-api/posts/hide-replies/integrate/manage-replies-in-realtime
---

With the hide replies endpoint, you can build a workflow to help your users hide replies that. Reference for the X API v2 standard tier covering integrate.
