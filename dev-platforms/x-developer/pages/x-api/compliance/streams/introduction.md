...
source: https://docs.x.com/x-api/compliance/streams/introduction
path: x-api/compliance/streams/introduction
---

Use X API v2 compliance event streams to keep stored X data in sync with Post deletes, edits, and account changes for users in near real time.
