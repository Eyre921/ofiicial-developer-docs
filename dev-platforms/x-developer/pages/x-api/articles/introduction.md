...
source: https://docs.x.com/x-api/articles/introduction
path: x-api/articles/introduction
---

Use the X API v2 Articles endpoints to programmatically create draft long-form Articles with rich text, media, and embedded Posts, then publish them to X.
...
```bash title="draft" lines wrap icon="terminal" theme={null}
