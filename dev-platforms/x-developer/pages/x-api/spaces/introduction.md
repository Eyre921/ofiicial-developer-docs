...
source: https://docs.x.com/x-api/spaces/introduction
path: x-api/spaces/introduction
---

Use the X API v2 Spaces endpoints to look up live or scheduled audio Spaces, search by keyword, and inspect creators, hosts, speakers, and listener details.
