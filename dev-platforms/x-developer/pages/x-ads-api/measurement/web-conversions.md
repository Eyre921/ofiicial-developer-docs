...
source: https://docs.x.com/x-ads-api/measurement/web-conversions
path: x-ads-api/measurement/web-conversions
---

Set up and use the X Ads API web conversions endpoints to track website conversion events, measure ad performance, and optimize campaign delivery.
