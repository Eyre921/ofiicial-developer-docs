...
source: https://docs.x.com/x-ads-api/fundamentals/making-authenticated-requests
path: x-ads-api/fundamentals/making-authenticated-requests
---

How to make authenticated X Ads API requests over HTTPS using OAuth 1.0a, including Twurl setup, HTTP verbs, in-line parameters, and URL encoding rules.

Accessing the X Ads API endpoints requires your application to send authenticated web requests securely using TLS to [https://ads-api.x.com](https://ads-api.x.com).
...
1. Collect 7 key/value pairs for the header - starting with oauth\_
