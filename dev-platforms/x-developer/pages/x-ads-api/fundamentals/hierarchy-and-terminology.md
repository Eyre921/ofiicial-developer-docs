...
source: https://docs.x.com/x-ads-api/fundamentals/hierarchy-and-terminology
path: x-ads-api/fundamentals/hierarchy-and-terminology
---

Glossary of X Ads API hierarchy and terminology covering accounts, campaigns, line items, creatives, cards, funding instruments, and audience concepts.
...
At the top of the X Ads hierarchy are ads accounts. An ads account can be managed by multiple X users. @Furni, our demo furniture store, would be an example of a user who manages an ads account. We identify ads accounts by an account\_id, which is a [base36](https://en.wikipedia.org/wiki/Base36) alpha-numeric string.
