---
title: "Rate limiting"
source: https://docs.x.com/x-ads-api/fundamentals/rate-limiting
path: x-ads-api/fundamentals/rate-limiting
---

The Advertiser API is rate limited similarly to REST API v1.1, as documented here: REST API Rate Limiting in v1.1. Unlike REST API v1.1, there is no.
