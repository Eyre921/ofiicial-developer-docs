---
title: "oEmbed API"
source: https://docs.x.com/x-for-websites/timelines/guides/oembed-api
path: x-for-websites/timelines/guides/oembed-api
---

Return a simple embed HTML for a X timeline specified by the timeline URL, in an oEmbed-compatible JSON format. User, list, likes, and collection timelines.
