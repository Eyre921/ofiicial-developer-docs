...
source: https://docs.x.com/x-for-websites/overview
path: x-for-websites/overview
---
...
<CardGroup>
  <Card title="Tweet Button" icon="toggle-on">
    ...
    [Learn more](https://developer.x.com/en/docs/twitter-for-websites/tweet-button/overview.html) <Icon icon="angle-right" />
  </Card>
  ...
  <Card title="Follow Button" icon="toggle-on">
    ...
    [Learn more](https://developer.x.com/en/docs/twitter-for-websites/follow-button/overview.html)<Icon icon="angle-right" />
  </Card>
</CardGroup>
