...
source: https://docs.x.com/x-for-websites/javascript-api/guides/scripting-factory-functions
path: x-for-websites/javascript-api/guides/scripting-factory-functions
---
...
* `screen_name`: The screen\_name of a user to be followed, or mentioned.
