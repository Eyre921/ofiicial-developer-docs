...
source: https://docs.x.com/x-for-websites/log-in-with-x/guides/browser-sign-in-flow
path: x-for-websites/log-in-with-x/guides/browser-sign-in-flow
---

How the Sign in with X browser flow works on desktop and mobile, redirecting users to x.com for authorization before returning to your application URL.
