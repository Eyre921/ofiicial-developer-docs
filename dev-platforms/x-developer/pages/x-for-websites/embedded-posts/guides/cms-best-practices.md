...
source: https://docs.x.com/x-for-websites/embedded-posts/guides/cms-best-practices
path: x-for-websites/embedded-posts/guides/cms-best-practices
---

An embedded Post adds pieces of the global conversation happening on X to your site, content, and commentary. Sites powered by a CMS or custom software can.
...
A Post ID is preferred over a Post's web URL: components of the URL such as the associated account’s screen\_name may change; the Post ID is unique to the cited content and will remain the same.
