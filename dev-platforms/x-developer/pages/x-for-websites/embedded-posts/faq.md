...
source: https://docs.x.com/x-for-websites/embedded-posts/faq
path: x-for-websites/embedded-posts/faq
---

An embedded Post comes in two parts: a containing Post information and the JavaScript file from a X server which converts the into a fully-rendered Post.
