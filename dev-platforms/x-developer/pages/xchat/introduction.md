...
source: https://docs.x.com/xchat/introduction
path: xchat/introduction
---

Learn what the X Chat API offers: send and receive encrypted direct messages on X, with the Chat XDK handling the hard parts for you.
