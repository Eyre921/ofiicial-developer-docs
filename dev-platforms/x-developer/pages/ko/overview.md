...
<Card title="사용량 기반 가격 변경: Owned Reads 도입" icon="bolt">
  <div>
    <div>
      <img alt="X logo" />
    </div>
    ...
    <div>
      Owned Reads를 통해 본인의 데이터에 더 낮은 비용으로 액세스할 수 있습니다. 본인 게시물, 북마크, 팔로워, 좋아요 등에 대한 요청은 <span>리소스당 \$0.001</span>의 가격으로 제공됩니다.
