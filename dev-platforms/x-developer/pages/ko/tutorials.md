...
<CardGroup>
  <Card title="사용자의 게시물 살펴보기" icon="user">
  ...
  <Card title="Postman 시작하기" icon="rocket">
  ...
  <Card title="R 및 X API v2 시작하기" icon="rocket">
  ...
  <Card title="full-archive search 엔드포인트로 과거 게시물 가져오기" icon="magnifying-glass">
  ...
  <Card title="Google Cloud Platform으로 X 데이터 후처리" icon="cloud">
