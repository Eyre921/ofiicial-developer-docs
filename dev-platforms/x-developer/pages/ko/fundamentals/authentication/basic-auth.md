...
path: ko/fundamentals/authentication/basic-auth
---

HTTP Basic authentication을 사용하여 PowerTrack, Decahose, Search 같은 X 엔터프라이즈 API에 HTTPS를 통해 이메일과 비밀번호를 전송하여 액세스하세요.
