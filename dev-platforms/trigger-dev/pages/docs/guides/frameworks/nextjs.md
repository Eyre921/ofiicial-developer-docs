...
path: docs/guides/frameworks/nextjs
---
...
For this guide, we'll manually deploy your task by running the [CLI deploy command](/docs/cli-deploy-commands) below. Other ways to deploy are listed in the next section.
