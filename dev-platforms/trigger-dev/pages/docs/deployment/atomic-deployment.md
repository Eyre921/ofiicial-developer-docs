...
path: docs/deployment/atomic-deployment
---
...
<Warning>
  **There's now a simpler way to do this.** [Version skew
  protection](/docs/deployment/version-skew-protection) solves the same problem without a second
  ...
  integration](/docs/vercel-integration), its **automatic atomic deployments** setting is now deprecated
