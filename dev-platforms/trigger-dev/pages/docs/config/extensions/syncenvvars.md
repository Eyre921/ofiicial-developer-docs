...
path: docs/config/extensions/syncenvvars
---
...
<Tip>
  Infisical also offers a native [Secret Sync](/docs/deploy-environment-variables#infisical-secret-sync)
