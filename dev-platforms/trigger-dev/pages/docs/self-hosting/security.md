...
source: https://trigger.dev/docs/self-hosting/security
...
We patch the **latest released version line** only. Run the latest version-tagged release to receive security fixes — see [Self-hosting overview](/docs/self-hosting/overview).
