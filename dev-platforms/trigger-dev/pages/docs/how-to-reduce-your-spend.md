...
path: docs/how-to-reduce-your-spend
---
...
You can open the settings from the **Organization** menu in the top left of the dashboard, then **Settings** → **Billing limits**. [Read the full billing limits and alerts docs](/docs/billing-limits) for how limits are enforced, the grace period, and resuming after hitting a limit.
...
Waiting saves you compute, but it doesn't always free up concurrency — see [Wait](/docs/wait).
