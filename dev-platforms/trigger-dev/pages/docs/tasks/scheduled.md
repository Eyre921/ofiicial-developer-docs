...
When you run the [dev](/docs/cli-dev-commands) or [deploy](/docs/cli-deploy-commands) commands, declarative schedules will be synced. If you add, delete or edit the `cron` property it will be updated when you run these commands. You can view your schedules on the Schedules page in the dashboard.
