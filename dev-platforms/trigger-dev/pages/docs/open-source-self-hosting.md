...
path: docs/open-source-self-hosting
---
...
If you want to deploy v3 projects, you will need access to a Docker registry. The [CLI deploy](/docs/cli-deploy-commands) command will push the images, and then the worker machine can pull them when needed. We will use Docker Hub as an example.
