...
- `reference/admin/create-credit-limit-policy` — [Create a credit limit policy](pages/reference/admin/create-credit-limit-policy.md) · [原文](https://developers.notion.com/reference/admin/create-credit-limit-policy)
...
- `reference/admin/expire-credit-limit-policy` — [Expire a credit limit policy](pages/reference/admin/expire-credit-limit-policy.md) · [原文](https://developers.notion.com/reference/admin/expire-credit-limit-policy)
...
- `reference/admin/list-credit-limit-policies` — [List credit limit policies](pages/reference/admin/list-credit-limit-policies.md) · [原文](https://developers.notion.com/reference/admin/list-credit-limit-policies)
...
- `reference/admin/update-credit-limit-policy` — [Update a credit limit policy](pages/reference/admin/update-credit-limit-policy.md) · [原文](https://developers.notion.com/reference/admin/update-credit-limit-policy)
