...
| `has_pending_attachments` | `boolean`                                                                   | Whether any files attached to the comment are still uploading. Files that are still uploading aren't listed in `attachments`. See [Attachments that are still uploading](/reference/comment-attachment#attachments-that-are-still-uploading). | `false`                                                                                                                                                                        |
