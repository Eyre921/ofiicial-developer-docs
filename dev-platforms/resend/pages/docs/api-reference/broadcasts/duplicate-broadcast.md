...
source: https://resend.com/docs/api-reference/broadcasts/duplicate-broadcast
path: docs/api-reference/broadcasts/duplicate-broadcast
---

POST /broadcasts/:broadcast_id/duplicate
