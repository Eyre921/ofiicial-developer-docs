---
title: "Runs"
source: https://resend.com/docs/dashboard/automations/runs
path: docs/dashboard/automations/runs
---
...
<Tabs>
  <Tab title="Using the dashboard">
    ...
    <img alt="Automation Runs Filter" />
  </Tab>
