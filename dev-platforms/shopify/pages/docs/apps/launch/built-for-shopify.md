...
source: https://shopify.dev/docs/apps/launch/built-for-shopify.md
path: docs/apps/launch/built-for-shopify
---

---
title: About Built for Shopify
description: >-
  Learn about our quality standards for apps, and how you can earn achievements
  and get your app promoted.
source_url:
  html: 'https://shopify.dev/docs/apps/launch/built-for-shopify'
  md: 'https://shopify.dev/docs/apps/launch/built-for-shopify.md'
---
