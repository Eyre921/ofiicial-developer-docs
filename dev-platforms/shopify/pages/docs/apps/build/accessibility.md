---
title: "Ensure your app is accessible"
source: https://shopify.dev/docs/apps/build/accessibility.md
path: docs/apps/build/accessibility
---

---
title: Accessibility best practices for Shopify apps
description: Learn how to increase the accessibility of your Shopify app.
source_url:
  html: 'https://shopify.dev/docs/apps/build/accessibility'
  md: 'https://shopify.dev/docs/apps/build/accessibility.md'
---

# Accessibility best practices for Shopify apps

When you build an app, make design choices that help keep content accessible. An accessible app is designed so that it can be used by everyone, including people who rely on [assistive technology](https://www.w3.org/WAI/perspective-videos/). Accessibility for your app is essential to providing an inclusive experience for app users and customers.

The accessibility best practices for Shopify apps were created with the [Web Content Accessibility Guidelines (WCAG)](https://www.w3.org/TR/WCAG21/) in mind.
...
You can use an [online contrast ratio tool](https://contrast-ratio.com/) to check the contrast of the different parts of your app.
