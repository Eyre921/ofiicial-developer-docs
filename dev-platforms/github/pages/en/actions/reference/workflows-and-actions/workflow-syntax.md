...
source: https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax.md
path: en/actions/reference/workflows-and-actions/workflow-syntax
---
...
| `'*.js'`                                            | The `*` wildcard matches any character, but does not match slash (`/`). Matches all `.js` files at the root of the repository.                                          # Workflow syntax for GitHub Actions
