...
source: https://docs.github.com/en/copilot/reference/ai-models/model-comparison.md
path: en/copilot/reference/ai-models/model-comparison
---
...
|                                       |                                                    |                                                                                                                                                                |                                                                                                                            |
| Claude Opus 4.8 (fast mode) (preview) | Deep reasoning and debugging                       | Complex problem-solving challenges, sophisticated reasoning                                                                                                    | Not available                                                                                                              |
|                                       |                                                    |                                                                                                                                                                |                                                                                                                            |
...
|                                       |                                                    |                                                                                                                                                                |                                                                                                                            |
| Claude Sonnet 5                       | General-purpose coding and agent tasks             | Complex problem-solving challenges, sophisticated reasoning                                                                                                    | Not available                                                                                                              |
|                                       |                                                    |                                                                                                                                                                |                                                                                                                            |
