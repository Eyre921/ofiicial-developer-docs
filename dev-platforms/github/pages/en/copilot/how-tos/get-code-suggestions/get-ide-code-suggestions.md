...
source: https://docs.github.com/en/copilot/how-tos/get-code-suggestions/get-ide-code-suggestions.md
path: en/copilot/how-tos/get-code-suggestions/get-ide-code-suggestions
---
...
* **Access to Copilot**. To use GitHub Copilot in JetBrains, you need either limited access through Copilot Free or a paid Copilot plan for full access. See [About GitHub Copilot](/en/copilot/get-started/about-github-copilot#get-access).
...
* **Access to Copilot**. To use GitHub Copilot in GitHub Copilot in Visual Studio, you need either limited access through Copilot Free or a paid Copilot plan for full access. See [About GitHub Copilot](/en/copilot/get-started/about-github-copilot#get-access).
...
* **Access to Copilot**. To use GitHub Copilot in Visual Studio Code, you need either limited access through Copilot Free or a paid Copilot plan for full access. See [About GitHub Copilot](/en/copilot/get-started/about-github-copilot#get-access).
...
* **Access to Copilot**. To use GitHub Copilot in Vim/Neovim, you need either limited access through Copilot Free or a paid Copilot plan for full access. See [About GitHub Copilot](/en/copilot/get-started/about-github-copilot#get-access).
...
* **Access to Copilot**. To use GitHub Copilot in Azure Data Studio, you need either limited access through Copilot Free or a paid Copilot plan for full access. See [About GitHub Copilot](/en/copilot/get-started/about-github-copilot#get-access).
...
* **Access to Copilot**. To use GitHub Copilot in Xcode, you need either limited access through Copilot Free or a paid Copilot plan for full access. See [About GitHub Copilot](/en/copilot/get-started/about-github-copilot#get-access).
...
* **Access to Copilot**. To use GitHub Copilot in Eclipse, you need either limited access through Copilot Free or a paid Copilot plan for full access. See [About GitHub Copilot](/en/copilot/get-started/about-github-copilot#get-access).
