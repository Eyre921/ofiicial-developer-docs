...
source: https://docs.github.com/en/get-started/git-basics/configuring-git-to-handle-line-endings.md
path: en/get-started/git-basics/configuring-git-to-handle-line-endings
---
