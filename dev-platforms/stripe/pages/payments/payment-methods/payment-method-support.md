---
title: "more than 20 payment methods"
source: https://docs.stripe.com/payments/payment-methods/payment-method-support.md
path: payments/payment-methods/payment-method-support
---
...
> #### Connected accounts
> 
> If you have a platform or marketplace integration that uses Connect, your connected accounts might have different eligibility requirements than your account. To learn about connected account eligibility and capabilities, see [Payment method support for Connect platforms and marketplaces](https://docs.stripe.com/payments/payment-methods/payment-method-connect-support.md).
...
| [Bacs Direct Debit](https://docs.stripe.com/payments/bacs-debit.md) | ✓ Supported | ✓ Supported | ✓ Supported | ✓ Supported | - Unsupported | ✓ Supported | ✓ Supported 1 | ✓ Supported | ✓ Supported |
...
| [Bacs Direct debit](https://docs.stripe.com/payments/bacs-debit.md) | `bacs_debit` | ✓ Supported 3 | - Unsupported 4 | - Unsupported | ✓ Supported | No |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Custom payment methods | ✓ Supported | ✓ Supported | - Unsupported | ✓ Supported | ✓ Supported 1 | ✓ Supported | ✓ Supported | ✓ Supported | ✓ Supported |

1 In private preview.
