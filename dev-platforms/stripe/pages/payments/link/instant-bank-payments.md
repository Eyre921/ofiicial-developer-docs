...
path: payments/link/instant-bank-payments
---
...
- When creating a [Checkout Session](https://docs.stripe.com/api/checkout/sessions/object.md#checkout_session_object-payment_method_types), if you explicitly offer ACH Direct Debit by including `us_bank_account` in `payment_method_types`, Link never presents Instant Bank Payments as a payment option. The same applies when you include `us_bank_account` in `allowed_payment_method_types` on a [PaymentIntent](https://docs.stripe.com/api/payment_intents/object.md#payment_intent_object-allowed_payment_method_types) or [SetupIntent](https://docs.stripe.com/api/setup_intents/create.md#create_setup_intent-allowed_payment_method_types).
