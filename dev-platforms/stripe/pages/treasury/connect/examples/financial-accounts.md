---
title: "Use Treasury for platforms and Issuing to set up financial accounts and cards"
source: https://docs.stripe.com/treasury/connect/examples/financial-accounts.md
path: treasury/connect/examples/financial-accounts
---
