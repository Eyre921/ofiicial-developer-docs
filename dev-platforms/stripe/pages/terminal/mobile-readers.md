---
title: "Stripe Terminal mobile readers"
source: https://docs.stripe.com/terminal/mobile-readers.md
path: terminal/mobile-readers
---
...
| [BBPOS WisePad 3](https://docs.stripe.com/terminal/readers/bbpos-wisepad3.md) | Available in: CA, GB, IE, SG, AU, NZ, FR, DE, NL, BE, AT, ES, DK, SE, NO, CH, IT, LU, PT, FI, HK, MY, CZ, PL, JP, BG, HR, CY, EE, HU, LV, LI, LT, MT, RO, SK, SI |
