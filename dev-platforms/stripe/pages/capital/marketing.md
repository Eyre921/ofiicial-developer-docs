---
title: "Marketing your Capital program"
source: https://docs.stripe.com/capital/marketing.md
path: capital/marketing
---
...
| --- | --- | --- |
| AU | Financing is provided by Fundbox, an external finance provider, with payments facilitated by Stripe. Funding amounts, rates, and terms are based on review and approval of a completed application, and are subject to change. In some cases, Fundbox requires additional documentation. | `fundbox_au_financing` |
| CA | Financing is provided by Fundbox, an external third-party provider, with payments facilitated by Stripe. Funding amounts, rates, and terms are based on review and approval of a completed application, and are subject to change. In some cases, Fundbox requires additional documentation. Stripe receives a fee from Fundbox in connection with financing provided through this program. | `fundbox_ca_financing` |
