---
title: "Choose your onboarding configuration"
...
| **SUPPORT NETWORKED ONBOARDING** | ✓ Supported | ✓ Supported | ❌ |
...
Stripe-hosted onboarding is a web form hosted by Stripe with your brand’s name, color, and icon, and is localized for all Stripe-supported countries. Stripe-hosted onboarding uses the [Accounts v2 API](https://docs.stripe.com/api/v2/core/accounts.md) to read an account’s requirements and generate a custom guided flow. It lets the account user upload documents and applies data validation, including real-time verification when possible.
