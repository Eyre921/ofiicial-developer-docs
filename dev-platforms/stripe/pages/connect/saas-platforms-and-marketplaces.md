---
title: "SaaS platforms and marketplaces guide"
source: https://docs.stripe.com/connect/saas-platforms-and-marketplaces.md
path: connect/saas-platforms-and-marketplaces
---
...
- Your platform collects per-payment *application fees* (A fee that Connect platforms collect from connected accounts for each payment or payout) from connected accounts.
