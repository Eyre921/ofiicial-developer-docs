...
| Checkout Session created with [automatic_tax](https://docs.stripe.com/api/checkout/sessions/create.md#create_checkout_session-automatic_tax-enabled) enabled, in subscription [mode](https://docs.stripe.com/api/checkout/sessions/create.md#create_checkout_session-mode) | Fee charged each time the subscription renews and the renewal invoice is finalized, if there’s an active tax registration covering the customer jurisdiction at the time |
| Checkout Session created with [automatic_tax](https://docs.stripe.com/api/checkout/sessions/create.md#create_checkout_session-automatic_tax-enabled) enabled, in payment [mode](https://docs.stripe.com/api/checkout/sessions/create.md#create_checkout_session-mode) | Fee charged when the Checkout Session is completed, if there’s an active tax registration covering the customer jurisdiction at the time |
| One-off invoice created with [automatic_tax](https://docs.stripe.com/api/invoices/create.md#create_invoice-automatic_tax) enabled and [finalized](https://docs.stripe.com/api/invoices/finalize.md). This includes invoices that remain unpaid and invoices later [marked as paid out of band](https://support.stripe.com/questions/marking-an-invoice-paid-out-of-band) after payment is collected outside Stripe. | Fee charged when the invoice is finalized, if there’s an active tax registration covering the customer jurisdiction at the time. The fee is based on [invoice finalization](https://docs.stripe.com/invoicing/integration/workflow-transitions.md), not whether, when, or how payment is collected. Marking the invoice as paid out of band later doesn’t change the fee. |
...
| Payment Link Session created with [automatic_tax](https://docs.stripe.com/api/payment-link/create.md#create_payment_link-automatic_tax) enabled, in payment mode | Fee is charged when the Payment Link Session is completed, if there’s an active tax registration covering the customer jurisdiction at the time |
