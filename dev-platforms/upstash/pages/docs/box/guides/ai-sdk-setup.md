...
* [Filesystem](/docs/box/overall/files) and [shell](/docs/box/overall/shell) for the full API behind these tools.
* [Browser](/docs/box/overall/browser/overview) to add page reading and screenshots to the toolset.
* [Public URLs](/docs/box/overall/preview) for authenticating the URLs `exposePort` hands out.
* [Snapshots](/docs/box/overall/snapshots) to boot each conversation from a pre-installed environment.
