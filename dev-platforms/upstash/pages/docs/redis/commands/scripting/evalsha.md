---
title: "EVALSHA"
source: https://upstash.com/docs/redis/commands/scripting/evalsha
path: docs/redis/commands/scripting/evalsha
---
...
* The cached script takes the global lock unless its shebang sets the `allow-key-locking` flag. See [Key-Based Locking](/docs/redis/features/key-locking).
