---
title: "ARSEEK"
source: https://upstash.com/docs/redis/commands/array/arseek
path: docs/redis/commands/array/arseek
---

Use `ARSEEK` to set the index that the next [`ARINSERT`](/docs/redis/commands/array/arinsert) will write to.
