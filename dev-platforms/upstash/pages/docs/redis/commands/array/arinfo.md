---
title: "ARINFO"
source: https://upstash.com/docs/redis/commands/array/arinfo
path: docs/redis/commands/array/arinfo
---
...
| Field | Description |
| --- | --- |
| `len` | Highest occupied index plus one, as reported by [`ARLEN`](/docs/redis/commands/array/arlen). |
| `count` | Number of occupied slots, as reported by [`ARCOUNT`](/docs/redis/commands/array/arcount). |
...
| `next-insert-index` | Index the next [`ARINSERT`](/docs/redis/commands/array/arinsert) would write to. |
