---
title: "ARNEXT"
source: https://upstash.com/docs/redis/commands/array/arnext
path: docs/redis/commands/array/arnext
---

Use `ARNEXT` to read the index that the next [`ARINSERT`](/docs/redis/commands/array/arinsert) would write to.
...
Because the cursor tracks appends rather than contents, `ARNEXT` is unaffected by [`ARSET`](/docs/redis/commands/array/arset) writes and by deletions. [`ARSEEK`](/docs/redis/commands/array/arseek) is the command that moves it.
