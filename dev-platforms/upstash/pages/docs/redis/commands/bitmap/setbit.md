---
title: "SETBIT"
source: https://upstash.com/docs/redis/commands/bitmap/setbit
path: docs/redis/commands/bitmap/setbit
---
...
Bitmaps built this way are read back with [`GETBIT`](/docs/redis/commands/bitmap/getbit), counted with [`BITCOUNT`](/docs/redis/commands/bitmap/bitcount), and combined with [`BITOP`](/docs/redis/commands/bitmap/bitop).
