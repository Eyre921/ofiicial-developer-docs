---
title: "BITCOUNT"
source: https://upstash.com/docs/redis/commands/bitmap/bitcount
path: docs/redis/commands/bitmap/bitcount
---
...
`BITCOUNT` is the usual way to read a bitmap built with [`SETBIT`](/docs/redis/commands/bitmap/setbit), for example to count how many users were active on a given day when each user has a fixed bit position.
