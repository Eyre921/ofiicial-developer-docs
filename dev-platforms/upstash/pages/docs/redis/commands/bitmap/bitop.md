---
title: "BITOP"
source: https://upstash.com/docs/redis/commands/bitmap/bitop
path: docs/redis/commands/bitmap/bitop
---
...
This is how bitmaps are used as sets: with one bit per user, `AND` gives users present in every bitmap and `OR` gives users present in any of them, and [`BITCOUNT`](/docs/redis/commands/bitmap/bitcount) then turns the result into a number.
