---
title: "XDELEX"
source: https://upstash.com/docs/redis/commands/streams/xdelex
...
That last policy is what makes the command useful as a safe cleanup step: it removes exactly the entries nobody still owes work on. The reply holds one status code per requested ID, in the order they were given. Where [`XDEL`](/docs/redis/commands/streams/xdel) always behaves like `KEEPREF`, `XDELEX` is its explicit form.
