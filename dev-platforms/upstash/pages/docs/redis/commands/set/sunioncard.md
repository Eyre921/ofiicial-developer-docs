---
title: "SUNIONCARD"
source: https://upstash.com/docs/redis/commands/set/sunioncard
path: docs/redis/commands/set/sunioncard
---

Use `SUNIONCARD` to count the distinct members that appear in at least one of the given sets. It returns only the count; use [`SUNION`](/docs/redis/commands/set/sunion) to retrieve the members.
