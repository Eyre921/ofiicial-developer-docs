---
title: "SDIFFCARD"
source: https://upstash.com/docs/redis/commands/set/sdiffcard
path: docs/redis/commands/set/sdiffcard
---

Use `SDIFFCARD` to count the members of the first set that are not present in any of the other sets. It returns only the count; use [`SDIFF`](/docs/redis/commands/set/sdiff) to retrieve the members.
