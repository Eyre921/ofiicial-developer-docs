...
path: docs/redis/tutorials/redis_queue
---

> How to build FIFO, reliable, and blocking queues on Upstash Redis, then a delayed and prioritized job queue with a dead-letter queue.
