...
* Expanded [Redis Search](/docs/redis/search/introduction) with [searchable Redis streams](/docs/redis/search/streams), multi-value text and keyword fields, and [composite aggregations](/docs/redis/search/aggregation-operators/bucket-aggregations/composite).
* Increased Redis compatibility with [`MSETEX`](/docs/redis/commands/string/msetex), [`SDIFFCARD`](/docs/redis/commands/set/sdiffcard), and [`SUNIONCARD`](/docs/redis/commands/set/sunioncard).
</Update>
