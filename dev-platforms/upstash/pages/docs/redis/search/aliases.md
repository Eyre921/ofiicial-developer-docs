...
path: docs/redis/search/aliases
---
...
The [`SEARCH.ALIASADD`](/docs/redis/commands/search/search-aliasadd) command creates a new alias or updates an existing alias to point to a different index.
...
The [`SEARCH.ALIASDEL`](/docs/redis/commands/search/search-aliasdel) command removes an alias.
...
The [`SEARCH.LISTALIASES`](/docs/redis/commands/search/search-listaliases) command returns all aliases and the indices they point to.
