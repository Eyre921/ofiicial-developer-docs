...
path: docs/redis/search/schema-definition
---
...
start in one element and continue in another. See [Multi-value queries](/docs/redis/search/querying#multi-value-fields)
