...
path: docs/redis/search/document-updates
---
...
Use [`SEARCH.WAITINDEXING`](/docs/redis/commands/search/search-waitindexing) when you need to ensure queries reflect recent changes.
...
See [Searching Streams](/docs/redis/search/streams) for stream-specific schema rules and operational
constraints.
