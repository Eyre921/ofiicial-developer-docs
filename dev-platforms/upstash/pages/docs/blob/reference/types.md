---
title: "Types"
source: https://upstash.com/docs/blob/reference/types
path: docs/blob/reference/types
---
...
One of three words, a `Duration`, or a raw `Cache-Control` header. The header each one stores is on [Caching](/docs/blob/bucket/caching#the-cache-option).
...
The PUTs that carry the bytes go to storage, never to your route. [How signing works](/docs/blob/reference/signing#the-direct-upload-handshake) has the full handshake.
