...
If you're a Team Owner, you can change a team member's permissions from the **Team members** list under 
### NavigationPath Component:

Team settings > Members
. Team member permissions include changing a team member's role or modifying their access to projects.
...
3. Select the **Reviewers** tab. On Pro and higher plans, select the **Member requests** tab instead. The list indicates whether a Reviewer is pending or approved.
...
Team settings > Members
 and select the **Reviewers** tab (or **Member requests** on Pro and higher plans).

2. Select 
### NavigationPath Component:

Options > Block
 to remove a pending Reviewer from the list and block any future Reviewer requests with the associated email address.
...
Team settings > Members
 page, you can access a list of your team's active and inactive [Git Contributors](/manage/accounts-and-billing/team-management/roles-and-permissions#git-contributor). To remove an inactive Git Contributor, choose the Git Contributor you would like to remove and select 
### NavigationPath Component:
