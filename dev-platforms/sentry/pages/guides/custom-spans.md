...
source: https://docs.sentry.io/guides/custom-spans.md
path: guides/custom-spans
---
...
You've got your Sentry SDK [auto-instrumentation](https://docs.sentry.io/product/trace-explorer.md) running. Now what?
...
Explore the [Trace Explorer product walkthrough guides](https://docs.sentry.io/product/trace-explorer.md) to learn more about the Sentry interface and discover additional tips.
