---
title: "What to Track"
source: https://docs.sentry.io/guides/metrics.md
path: guides/metrics
---
...
You've set up [Sentry Metrics](https://docs.sentry.io/product/metrics.md). Now what?
...
Explore the [Application Metrics product walkthrough](https://docs.sentry.io/product/metrics.md) to learn more about the Sentry interface and discover additional tips.
