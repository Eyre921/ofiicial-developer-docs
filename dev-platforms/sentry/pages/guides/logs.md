---
title: "What to Log"
source: https://docs.sentry.io/guides/logs.md
path: guides/logs
---
...
You've set up [Sentry Logs](https://docs.sentry.io/product/logs.md). Now what?
...
Explore the [Logs product walkthrough guides](https://docs.sentry.io/product/logs.md) to learn more about the Sentry interface and discover additional tips.
