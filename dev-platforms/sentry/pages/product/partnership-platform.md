...
source: https://docs.sentry.io/product/partnership-platform.md
path: product/partnership-platform
---
...
## [What's Available](https://docs.sentry.io/product/partnership-platform.md#whats-available)

Sentry provides two main integration paths for partners:

### [1. ](https://docs.sentry.io/product/partnership-platform.md#1-account-provisioning-api)[Account Provisioning API](https://docs.sentry.io/product/partnership-platform/account-provisioning-api.md)
...
### [2. ](https://docs.sentry.io/product/partnership-platform.md#2-oauth-integration)[OAuth Integration](https://docs.sentry.io/product/partnership-platform/oauth-integration.md)
...
## [Benefits for Your Platform](https://docs.sentry.io/product/partnership-platform.md#benefits-for-your-platform)
...
## [Getting Started](https://docs.sentry.io/product/partnership-platform.md#getting-started)
...
## [Contact Us](https://docs.sentry.io/product/partnership-platform.md#contact-us)
...
- [OAuth Integration](https://docs.sentry.io/product/partnership-platform/oauth-integration.md)
- [account-provisioning-api](https://docs.sentry.io/product/partnership-platform/account-provisioning-api.md)
