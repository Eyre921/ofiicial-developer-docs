---
title: "User Feedback"
source: https://docs.sentry.io/product/user-feedback.md
path: product/user-feedback
---
...
For example, using [Session Replay](https://docs.sentry.io/product/session-replay.md) with the User Feedback Widget could save you time, helping you quickly understand the context of the user problem by seeing exactly what they experienced before submitting their feedback.
...
* Associated replay event (with up to 60 seconds of replay recording before the user submitted the feedback)
  * Learn more about how to set up Session Replay [here](https://docs.sentry.io/product/session-replay.md).
