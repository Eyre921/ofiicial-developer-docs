...
source: https://docs.sentry.io/product/drains.md
path: product/drains
---
...
* [Logs](https://docs.sentry.io/product/logs.md): View, search, and analyze logs in Sentry
* [Trace Explorer](https://docs.sentry.io/product/trace-explorer.md): View, search, and analyze traces in Sentry
