---
title: "Discover"
source: https://docs.sentry.io/product/discover-queries.md
path: product/discover-queries
---

---
title: "Discover"
description: "Discover is a powerful query engine that allows you to query all your metadata across projects and environments to unlock insights."
url: https://docs.sentry.io/product/discover-queries/
---

# Discover

For performance data, [Trace Explorer](https://docs.sentry.io/product/trace-explorer.md) is the recommended tool. It queries spans directly and supports the full set of span attributes. Discover's Transactions dataset is deprecated; existing saved queries will continue to work but new performance queries should use Trace Explorer.

The Discover homepage displays the query builder where you can immediately begin creating a new query. By default, the page shows the pre-built "All Events" query, but you can customize the homepage and [set the custom version as your default](https://docs.sentry.io/product/discover-queries.md#set-as-default). To navigate back to the query management page, where you can find [pre-built](https://docs.sentry.io/product/discover-queries.md#pre-built-queries) and [saved](https://docs.sentry.io/product/discover-queries.md#saved-queries) queries, click the "Saved Queries" button.
...
## [Pre-built Queries](https://docs.sentry.io/product/discover-queries.md#pre-built-queries)
...
* Errors by URL: Users can see the pages that generated the most errors and different types of issues. As a reminder, issues are a group of fingerprinted Events. For more details, see the [full documentation on fingerprinting](https://docs.sentry.io/concepts/data-management/event-grouping/fingerprint-rules.md).

## [Saved Queries](https://docs.sentry.io/product/discover-queries.md#saved-queries)
...
### [Build a New Query](https://docs.sentry.io/product/discover-queries.md#build-a-new-query)

From the **Discover** page, you can build a [query](https://sandbox.sentry.io/?scenario=oneDiscoverQuery\&projectSlug=react\&source=docs) in three ways.
...
Apply new search conditions or table columns to modify the query results. Save the query and assign a custom display name. For the full details, see the [documentation on the Query Builder](https://docs.sentry.io/product/discover-queries/query-builder.md).

### [Search for a Query](https://docs.sentry.io/product/discover-queries.md#search-for-a-query)

Looking for a specific query? Use the search bar on the homepage to find the query name.

### [Sort Queries](https://docs.sentry.io/product/discover-queries.md#sort-queries)
...
### [Edit Queries](https://docs.sentry.io/product/discover-queries.md#edit-queries)
...
### [Share Queries](https://docs.sentry.io/product/discover-queries.md#share-queries)
...
### [Delete Queries](https://docs.sentry.io/product/discover-queries.md#delete-queries)

On the **Discover** page, each saved query card has an ellipsis that will open a context menu. From here, you can delete the query. This action is irreversible. You can also delete the query within the [query results](https://docs.sentry.io/product/discover-queries.md#query-results) view by clicking the "Delete Saved Query" option in the context menu.

### [Add to Dashboard](https://docs.sentry.io/product/discover-queries.md#add-to-dashboard)

Queries can also be added to [custom dashboards](https://sandbox.sentry.io/?scenario=dashboards\&projectSlug=react\&source=docs) as widgets. You can find the "Add to Dashboard" button by opening the context menu on the **Discover** page or within the context menu of the [query results](https://docs.sentry.io/product/discover-queries.md#query-results) view. When you click "Add to Dashboard", a form opens where you can name your widget. Select your target dashboard, and make any other required changes before saving your new widget.

### [Set as Default](https://docs.sentry.io/product/discover-queries.md#set-as-default)
...
## [Query Results](https://docs.sentry.io/product/discover-queries.md#query-results)
...
For more about how to build a query, go to [the Query Builder](https://docs.sentry.io/product/discover-queries/query-builder.md).

## [Trace Explorer](https://docs.sentry.io/product/discover-queries.md#trace-explorer)

You can see additional information about your event by clicking into any "Event ID" on the [**Discover**](https://sentry.io/orgredirect/organizations/:orgslug/discover) page. Clicking on any event type other than an error event, will take you to the [**Trace View**](https://docs.sentry.io/concepts/key-terms/tracing/trace-view.md) page. Clicking on an error event will take you to the [**Issues**](https://sentry.io/orgredirect/organizations/:orgslug/issues/) page.

## Pages in this section

- [Query Builder](https://docs.sentry.io/product/discover-queries/query-builder.md)
- [Uncover Trends With Discover](https://docs.sentry.io/product/discover-queries/uncover-trends.md)
