---
title: "CREATE VIEW"
source: https://docs.turso.tech/sql-reference/statements/create-view
path: sql-reference/statements/create-view
---

Create a named view based on a SELECT statement
