---
title: "Transactions"
source: https://docs.turso.tech/sql-reference/statements/transactions
path: sql-reference/statements/transactions
---

Start, commit, and roll back transactions to group operations atomically
