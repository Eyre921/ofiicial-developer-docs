...
source: https://docs.turso.tech/sql-reference/statements/create-virtual-table
path: sql-reference/statements/create-virtual-table
---

Create a virtual table backed by a module that provides custom data access
...
### Generate a Date Series with generate\_series
