...
source: https://docs.turso.tech/sql-reference/statements/create-materialized-view
path: sql-reference/statements/create-materialized-view
---

Create a materialized view that stores precomputed results and updates automatically
