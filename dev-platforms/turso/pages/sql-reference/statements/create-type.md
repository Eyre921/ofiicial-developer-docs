---
title: "CREATE TYPE"
source: https://docs.turso.tech/sql-reference/statements/create-type
path: sql-reference/statements/create-type
---

Define a custom type with encoding, decoding, validation, operators, and defaults for use in STRICT tables
...
### sqlite\_turso\_types Virtual Table
