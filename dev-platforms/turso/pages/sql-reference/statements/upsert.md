...
source: https://docs.turso.tech/sql-reference/statements/upsert
path: sql-reference/statements/upsert
---

Insert rows with automatic conflict resolution using DO NOTHING or DO UPDATE
