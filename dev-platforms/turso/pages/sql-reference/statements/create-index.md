---
title: "CREATE INDEX"
source: https://docs.turso.tech/sql-reference/statements/create-index
path: sql-reference/statements/create-index
---

Create an index on one or more columns or expressions to accelerate queries
