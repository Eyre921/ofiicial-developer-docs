---
title: "ANALYZE"
source: https://docs.turso.tech/sql-reference/statements/analyze
path: sql-reference/statements/analyze
---

Collect statistics about indexes to help the query optimizer
