---
title: "REPLACE"
source: https://docs.turso.tech/sql-reference/statements/replace
path: sql-reference/statements/replace
---

Insert a row, replacing any existing row that conflicts on a unique constraint
