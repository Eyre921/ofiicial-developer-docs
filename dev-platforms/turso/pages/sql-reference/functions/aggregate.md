...
source: https://docs.turso.tech/sql-reference/functions/aggregate
path: sql-reference/functions/aggregate
---
...
### percentile\_cont(fraction) and percentile\_disc(fraction)
