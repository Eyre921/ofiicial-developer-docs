...
source: https://docs.turso.tech/sql-reference/functions/window
path: sql-reference/functions/window
---

Perform calculations across sets of rows related to the current row without collapsing them
...
<Info>
  Turso supports aggregate functions used as window functions with the default frame definition. Custom frame specifications (ROWS, RANGE, or GROUPS with explicit bounds) and dedicated window functions (row\_number, rank, dense\_rank, ntile, lag, lead, first\_value, last\_value, nth\_value) are not yet supported.
</Info>
...
| department  | name  | salary | dept\_total |
| ----------- | ----- | ------ | ----------- |
...
| department  | name  | salary | dept\_running\_total |
| ----------- | ----- | ------ | -------------------- |
