...
source: https://docs.turso.tech/sql-reference/functions/scalar
path: sql-reference/functions/scalar
---

Built-in scalar functions for string manipulation, math, type inspection, and more
...
### length(X), char\_length(X), character\_length(X), and octet\_length(X)
...
### reverse(X) and string\_reverse(X)
