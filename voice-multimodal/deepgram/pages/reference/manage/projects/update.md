...
source: https://developers.deepgram.com/reference/manage/projects/update.md
path: reference/manage/projects/update
---
...
This endpoint expects an UpdateProjectV1Request.
...
HttpResponse<String> response = Unirest.patch("https://api.deepgram.com/v1/projects/123456-7890-1234-5678-901234")
...
$response = $client->request('PATCH', 'https://api.deepgram.com/v1/projects/123456-7890-1234-5678-901234', [
  'body' => '{}',
  'headers' => [
    'Authorization' => 'Token <apiKey>',
    'Content-Type' => 'application/json',
