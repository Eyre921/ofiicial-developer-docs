...
source: https://developers.deepgram.com/reference/manage/projects/delete.md
path: reference/manage/projects/delete
---
...
Reference: https://developers.deepgram.com/reference/manage/projects/delete
...
```json
{
  "message": "Project 123456-7890-1234-5678-901234 has been successfully deleted."
}
```
...
url = URI("https://api.deepgram.com/v1/projects/123456-7890-1234-5678-901234")
...
HttpResponse<String> response = Unirest.delete("https://api.deepgram.com/v1/projects/123456-7890-1234-5678-901234")
...
$response = $client->request('DELETE', 'https://api.deepgram.com/v1/projects/123456-7890-1234-5678-901234', [
  'body' => '{}',
  'headers' => [
    'Authorization' => 'Token <apiKey>',
    'Content-Type' => 'application/json',
