---
title: "Live Audio"
source: https://developers.deepgram.com/reference/speech-to-text/listen-streaming.md
path: reference/speech-to-text/listen-streaming
---
...
components:
  ...
  schemas:
    ...
    ListenV1Diarize:
      ...
      default: 'false'
      description: >-
        Deprecated. Use `diarize_model` instead. Defaults to `false`. Recognize
    ...
    ChannelsListenV1MessagesListenV1ResultsMetadataDiarizeInfo:
      ...
      required:
        ...
        - arch
      description: >-
        The diarizer that produced the speaker labels. Present only when a
        diarizer ran.
    ...
    ChannelsListenV1MessagesListenV1ResultsMetadata:
      ...
      properties:
        ...
        diarize_info:
          $ref: >-
            #/components/schemas/ChannelsListenV1MessagesListenV1ResultsMetadataDiarizeInfo
          description: >-
            The diarizer that produced the speaker labels. Present only when a
            diarizer ran.
      required:
