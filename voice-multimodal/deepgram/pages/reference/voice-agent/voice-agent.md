...
components:
  ...
  schemas:
    ...
    DeepgramSpeakProviderVersion:
      ...
      default: v1
      description: >-
        The Deepgram text-to-speech model family. Aura models use v1 (default).
        For Flux TTS, use v2. Defaults to v1 when omitted.
    ...
    DeepgramSpeakProvider:
      ...
      properties:
        ...
        version:
          ...
          default: v1
          description: >-
            The Deepgram text-to-speech model family. Aura models use v1
            (default). For Flux TTS, use v2. Defaults to v1 when omitted.
        model:
      ...
      required:
        ...
        - model
      description: >-
        Deepgram Aura text-to-speech provider (version v1). For Flux TTS, use
        version v2 and a flux-* model.
    ...
    SpeakSettingsV1ProviderOneOf1Model:
      ...
      enum:
        ...
        - flux-sharon-en
      description: >-
        Flux TTS model to use, in the format flux-{voice}-{language} (e.g.
        flux-alexis-en). See the Flux TTS voice catalog for the full list.
    ...
    SpeakSettingsV1Provider1:
      ...
      required:
        ...
        - model
      description: >-
        Deepgram Flux TTS text-to-speech provider (version v2). Flux TTS is in
        Early Access — the Flux TTS-specific API surface and voice catalog may
