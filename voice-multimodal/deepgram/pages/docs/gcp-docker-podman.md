...
source: https://developers.deepgram.com/docs/gcp-docker-podman.md
path: docs/gcp-docker-podman
---
...
6. For the **Machine configuration** wizard step, filter by "GPU". For each of the following sub-steps, follow the requirements listed in our [minimum required hardware specifications](/docs/self-hosted-deployment-environments#hardware-specifications).
...
9. For the **Boot Disk** wizard step, select "Change".
   ...
   3. For "Size (GB)", select a value that meets Deepgram's [minimum required hardware specifications](/docs/self-hosted-deployment-environments#hardware-specifications).
