---
title: "Keywords"
source: https://developers.deepgram.com/docs/keywords.md
path: docs/keywords
---
...
* [Try Keywords in Deepgram Playground](https://playground.deepgram.com/?endpoint=listen\&keywords=test%3A1\&language=en\&model=nova-2)
