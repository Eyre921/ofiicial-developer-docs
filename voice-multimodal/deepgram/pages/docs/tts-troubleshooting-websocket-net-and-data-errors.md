...
source: https://developers.deepgram.com/docs/tts-troubleshooting-websocket-net-and-data-errors.md
path: docs/tts-troubleshooting-websocket-net-and-data-errors
---
...
* Refer to the [Documentation](/reference/text-to-speech/speak-streaming) for valid message types.
...
* [Contact Support](/support) if the issue continues.
