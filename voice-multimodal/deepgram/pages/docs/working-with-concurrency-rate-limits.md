...
source: https://developers.deepgram.com/docs/working-with-concurrency-rate-limits.md
path: docs/working-with-concurrency-rate-limits
---
...
If you exceed your rate limits, the API will return a `429: Too Many Requests` error. This error indicates that your project has more concurrent requests than allowed. To learn more, see the [Deepgram Error Documentation](/docs/errors#429-rate-limit-exceeded-1).
