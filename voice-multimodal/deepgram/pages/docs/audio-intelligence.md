...
source: https://developers.deepgram.com/docs/audio-intelligence.md
path: docs/audio-intelligence
---
...
const transcribeFile = async () => {
  ...
  const result = await deepgram.listen.v1.media.transcribeFile(
    fs.createReadStream("callcenter.wav"),
    {
      model: "nova-3",
      sentiment: true,
      // intents: true,
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        // Read local file as bytes and transcribe with intelligence features
        byte[] audioData = Files.readAllBytes(Path.of("callcenter.wav"));
