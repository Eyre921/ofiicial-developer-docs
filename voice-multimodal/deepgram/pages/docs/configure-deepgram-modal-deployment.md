---
title: "Configure Deepgram on Modal"
source: https://developers.deepgram.com/docs/configure-deepgram-modal-deployment.md
path: docs/configure-deepgram-modal-deployment
---
...
3. Update the hardware literals in `modal_deepgram/app.py` to TTS-recommended values — see [Compute and Autoscaling → Configure hardware](/docs/modal-compute-and-autoscaling#configure-hardware).
