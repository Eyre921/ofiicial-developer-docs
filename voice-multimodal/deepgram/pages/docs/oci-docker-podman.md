...
source: https://developers.deepgram.com/docs/oci-docker-podman.md
path: docs/oci-docker-podman
---
...
6. For the **Image and shape** wizard step, click **Edit** to choose a basic configuration to serve as a template for your instance:
   ...
   1. Shape
      ...
      4. Search and select `VM.GPU.A10.1`, or another GPU instance type that meets our [minimum required hardware specifications](/docs/self-hosted-deployment-environments#hardware-specifications).
