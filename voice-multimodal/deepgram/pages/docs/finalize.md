---
title: "Finalize"
source: https://developers.deepgram.com/docs/finalize.md
path: docs/finalize
---
...
WebSocket ws = client.newWebSocketBuilder()
    ...
    .buildAsync(URI.create("wss://api.deepgram.com/v1/listen"), new WebSocket.Listener() {
        ...
        public void onOpen(WebSocket webSocket) {
            // Construct and send Finalize message
...
// Send Finalize message after 10 seconds to force processing of buffered audio
ScheduledExecutorService scheduler = Executors.newSingleThreadScheduledExecutor();
scheduler.schedule(() -> {
    wsClient.sendFinalize(ListenV1Finalize.builder()
        .type(ListenV1FinalizeType.FINALIZE)
        .build());
    System.out.println("Finalize message sent.");
}, 10, TimeUnit.SECONDS);
```
