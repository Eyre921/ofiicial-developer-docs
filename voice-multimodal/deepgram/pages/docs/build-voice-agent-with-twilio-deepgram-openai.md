---
title: "Build a Real-Time Phone Voice Agent with Twilio and the Deepgram Voice Agent API"
...
| Transcribe a call in real time, nothing spoken back         | [Twilio and Deepgram STT](https://developers.deepgram.com/docs/twilio-and-deepgram-stt) | `<Start><Stream>`   |
| Play generated speech into a call, no listening             | [Twilio and Deepgram TTS](https://developers.deepgram.com/docs/twilio-and-deepgram-tts) | `<Connect><Stream>` |
...
An optional `temperature` on the provider tunes how deterministic the replies are. See Deepgram's [Voice Agent LLM models](https://developers.deepgram.com/docs/voice-agent-llm-models) for the full list of supported providers and models.
...
* **Choose a different voice or model.** Swap the `speak` model for another [Flux voice](https://developers.deepgram.com/docs/flux-tts/voices), or change the `think` provider and model, for example to Anthropic's `claude-sonnet-5`. See [Choosing the language model](#choosing-the-language-model) in Step 4.
...
* [Deepgram Voice Agent STT models](https://developers.deepgram.com/docs/voice-agent-stt-models)
* [Deepgram Voice Agent LLM models](https://developers.deepgram.com/docs/voice-agent-llm-models)
* [Twilio + Deepgram Voice Agent integration](https://developers.deepgram.com/docs/twilio-and-deepgram-voice-agent)
