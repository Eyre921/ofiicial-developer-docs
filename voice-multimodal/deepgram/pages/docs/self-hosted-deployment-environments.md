...
source: https://developers.deepgram.com/docs/self-hosted-deployment-environments.md
path: docs/self-hosted-deployment-environments
---
...
If you use AWS, [Amazon SageMaker](/docs/amazon-sagemaker) offers a managed deployment path for Deepgram. Instead of provisioning your own infrastructure and container orchestrators, you subscribe to a Deepgram product listing on the AWS Marketplace and deploy a SageMaker Endpoint directly into your VPC. SageMaker handles instance provisioning, scaling, and container management.

This option is well-suited for teams that want a faster setup with less operational overhead. See the [Amazon SageMaker overview](/docs/amazon-sagemaker) for benefits, tradeoffs, and pricing, or jump straight to [Deploy Deepgram on Amazon SageMaker](/docs/deploy-amazon-sagemaker) to get started.
...
* **2 NVIDIA GPUs** (dual GPU requirement for TTS services)
  ...
  * Other commonly used cloud GPUs: NVIDIA A10, NVIDIA A100
    * **Azure** - Standard\_NV72ads\_A10\_v5 instances (NVIDIA A10)
...
The Deepgram API and Engine containers listen on port `8080` by default, and the Deepgram License Proxy listens on port `8443` by default, unless otherwise configured.
...
* [Amazon SageMaker](/docs/deploy-amazon-sagemaker)
* [Docker/Podman](/docs/dockerpodman)
* [Kubernetes](/docs/kubernetes)

After completing your environment setup and credentials configuration, you'll choose between STT or TTS deployment paths in the [Self Service Licensing & Credentials](/docs/self-hosted-self-service-tutorial) guide.
