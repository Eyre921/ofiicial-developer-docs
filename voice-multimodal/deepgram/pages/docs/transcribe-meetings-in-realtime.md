...
source: https://developers.deepgram.com/docs/transcribe-meetings-in-realtime.md
path: docs/transcribe-meetings-in-realtime
---
...
When connecting to the Deepgram server, you can configure options by appending query string parameters to the URL. To learn more about available options, check out our docs on the [Deepgram Live API](/reference/speech-to-text/listen-streaming).
