---
title: "AsyncAPI YAML"
source: https://developers.deepgram.com/asyncapi.yaml
path: asyncapi.yaml
---
    ...
    publish:
      ...
      message:
        oneOf:
          ...
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-13-AgentV1AgentStartedSpeaking'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-14-AgentV1AgentAudioDone'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-15-AgentV1Error'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-16-AgentV1Warning'
    ...
    subscribe:
      ...
      message:
        oneOf:
          ...
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-client-9-AgentV1Media'
  /v1/listen:
    ...
    subscribe:
      ...
      message:
        oneOf:
          ...
          - $ref: '#/components/messages/subpackage_listen/v2.listen.v2-client-2-ListenV2Configure'
  /v1/speak:
    ...
    publish:
      ...
      message:
        oneOf:
          ...
          - $ref: '#/components/messages/subpackage_speak/v2.speak.v2-server-4-SpeakV2Flushed'
          - $ref: '#/components/messages/subpackage_speak/v2.speak.v2-server-5-SpeakV2SessionMetadata'
          - $ref: '#/components/messages/subpackage_speak/v2.speak.v2-server-6-SpeakV2Warning'
          - $ref: '#/components/messages/subpackage_speak/v2.speak.v2-server-7-SpeakV2Error'
    subscribe:
      ...
      message:
        oneOf:
          ...
          - $ref: '#/components/messages/subpackage_speak/v2.speak.v2-client-2-SpeakV2Close'
servers:
  Production:
...
components:
  ...
  schemas:
    ...
    DeepgramListenProviderV2:
      ...
      properties:
        ...
        eot_threshold:
          type: number
          format: double
          description: 'End-of-turn confidence required to finish a turn. Valid range: 0.5 - 0.9. Defaults to 0.7.'
        eager_eot_threshold:
          type: number
          format: double
          description: >-
    ...
    DeepgramSpeakProviderVersion:
      ...
      default: v1
      description: >-
        The Deepgram text-to-speech model family. Aura models use v1 (default). For Flux TTS, use v2. Defaults to v1
        when omitted.
    ...
    DeepgramSpeakProvider:
      ...
      required:
        - type
        - model
      description: Deepgram Aura text-to-speech provider (version v1). For Flux TTS, use version v2 and a flux-* model.
      title: DeepgramSpeakProvider
    SpeakSettingsV1ProviderOneOf1Model:
      type: string
      enum:
        - flux-haley-en
        - flux-heather-en
        ...
        - flux-sharon-en
      description: >-
        Flux TTS model to use, in the format flux-{voice}-{language} (e.g. flux-alexis-en). See the Flux TTS voice
        catalog for the full list.
      title: SpeakSettingsV1ProviderOneOf1Model
    SpeakSettingsV1Provider1:
      ...
      properties:
        type:
          ...
          enum:
            - deepgram
          description: Provider type for text-to-speech
        version:
          type: string
          enum:
            - v2
          description: Selects the Deepgram Flux TTS model family
        model:
          $ref: '#/components/schemas/SpeakSettingsV1ProviderOneOf1Model'
          description: >-
            Flux TTS model to use, in the format flux-{voice}-{language} (e.g. flux-alexis-en). See the Flux TTS voice
            catalog for the full list.
      required:
        ...
        - model
      description: >-
        Deepgram Flux TTS text-to-speech provider (version v2). Flux TTS is in Early Access — the Flux TTS-specific API
        surface and voice catalog may change before general availability.
      title: SpeakSettingsV1Provider1
    ...
    SpeakSettingsV1Provider:
      oneOf:
        ...
        - $ref: '#/components/schemas/SpeakSettingsV1Provider1'
      ...
      properties:
        ...
        pronunciation_warnings:
          ...
          description: >-
            ...
            `dg-pronunciation-warnings` REST header. Always `0` during Early Access.
      required:
        - pronunciations_applied
        - pronunciation_warnings
      description: >-
        Controls applied during the turn. Inline pronunciation and pause controls are not available during Early Access,
        so every count is currently `0`.
    ...
    SpeakV2_SpeakV2SpeechMetadata:
      ...
      properties:
        ...
        controls_applied:
          ...
          description: >-
            Controls applied during the turn. Inline pronunciation and pause controls are not available during Early
            Access, so every count is currently `0`.
      required:
        - type
        - speech_id
        - audio_duration_ms
    ...
    SpeakV2_SpeakV2SessionMetadata:
      ...
      properties:
        ...
        total_audio_duration_ms:
          type: integer
          description: Cumulative audio duration produced across the session, in milliseconds
    ...
    SpeakV2_SpeakV2Warning:
      ...
      properties:
        ...
        code:
          type: string
          description: >-
            Warning code identifying the condition, in `SCREAMING_SNAKE_CASE`. Early Access codes are `NO_ACTIVE_SPEECH`
            (a speech-scoped message arrived with no active turn) and `SYNTHESIS_RETRYING` (a synthesis request failed
