    ...
    publish:
      ...
      message:
        oneOf:
          ...
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-11-AgentV1FunctionCallRequest'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-12-AgentV1AgentStartedSpeaking'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-13-AgentV1AgentAudioDone'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-14-AgentV1Error'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-15-AgentV1Warning'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-16-AgentV1History'
          - $ref: '#/components/messages/subpackage_agent/v1.agent.v1-server-17-AgentV1Audio'
    subscribe:
...
components:
  messages:
    ...
    subpackage_agent/v1.agent.v1-server-11-AgentV1FunctionCallRequest:
    ...
    subpackage_agent/v1.agent.v1-server-12-AgentV1AgentStartedSpeaking:
    ...
    subpackage_agent/v1.agent.v1-server-13-AgentV1AgentAudioDone:
    ...
    subpackage_agent/v1.agent.v1-server-16-AgentV1History:
      name: AgentV1History
    ...
    subpackage_agent/v1.agent.v1-server-17-AgentV1Audio:
      name: AgentV1Audio
      title: AgentV1Audio
