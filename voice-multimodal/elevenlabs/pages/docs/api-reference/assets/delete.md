---
title: "Delete Asset"
source: https://elevenlabs.io/docs/api-reference/assets/delete.md
path: docs/api-reference/assets/delete
---
...
DELETE https://api.elevenlabs.io/v1/assets/{asset_id}

Delete an asset by ID.

Reference: https://elevenlabs.io/docs/api-reference/assets/delete
