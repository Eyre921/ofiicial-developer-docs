...
HttpResponse<String> response = Unirest.get("https://api.elevenlabs.io/v1/assets/5xM2KqOnZyce22SPZ9d4")
  .asString();
```
...
$response = $client->request('GET', 'https://api.elevenlabs.io/v1/assets/5xM2KqOnZyce22SPZ9d4');
