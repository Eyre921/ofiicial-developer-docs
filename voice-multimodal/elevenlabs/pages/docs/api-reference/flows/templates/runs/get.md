...
source: https://elevenlabs.io/docs/api-reference/flows/templates/runs/get.md
path: docs/api-reference/flows/templates/runs/get
---
...
GET https://api.elevenlabs.io/v1/flows/templates/{template_id}/runs/{run_id}
...
Reference: https://elevenlabs.io/docs/api-reference/flows/templates/runs/get
...
url = URI("https://api.elevenlabs.io/v1/flows/templates/template_id/runs/run_id")
...
HttpResponse<String> response = Unirest.get("https://api.elevenlabs.io/v1/flows/templates/template_id/runs/run_id")
  .asString();
```
...
$response = $client->request('GET', 'https://api.elevenlabs.io/v1/flows/templates/template_id/runs/run_id');
...
var client = new RestClient("https://api.elevenlabs.io/v1/flows/templates/template_id/runs/run_id");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.elevenlabs.io/v1/flows/templates/template_id/runs/run_id")! as URL,
