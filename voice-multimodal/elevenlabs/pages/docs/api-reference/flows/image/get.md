...
source: https://elevenlabs.io/docs/api-reference/flows/image/get.md
path: docs/api-reference/flows/image/get
---
...
Reference: https://elevenlabs.io/docs/api-reference/flows/image/get
...
func main() {
	...
	url := "https://api.elevenlabs.io/v1/flows/image/generation_id"
...
url = URI("https://api.elevenlabs.io/v1/flows/image/generation_id")
...
HttpResponse<String> response = Unirest.get("https://api.elevenlabs.io/v1/flows/image/generation_id")
  .asString();
```
...
$response = $client->request('GET', 'https://api.elevenlabs.io/v1/flows/image/generation_id');
...
var client = new RestClient("https://api.elevenlabs.io/v1/flows/image/generation_id");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.elevenlabs.io/v1/flows/image/generation_id")! as URL,
