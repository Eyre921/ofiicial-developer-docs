---
title: "List Speech Generations"
source: https://elevenlabs.io/docs/api-reference/flows/text-to-speech/list.md
path: docs/api-reference/flows/text-to-speech/list
---
...
GET https://api.elevenlabs.io/v1/flows/text-to-speech

List the speech generations created through this API, newest first.

Reference: https://elevenlabs.io/docs/api-reference/flows/text-to-speech/list
...
HttpResponse<String> response = Unirest.get("https://api.elevenlabs.io/v1/flows/text-to-speech")
  .asString();
```
...
$response = $client->request('GET', 'https://api.elevenlabs.io/v1/flows/text-to-speech');
