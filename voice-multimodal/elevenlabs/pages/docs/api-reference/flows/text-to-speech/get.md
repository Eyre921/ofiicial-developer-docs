---
title: "Get Speech Generation"
source: https://elevenlabs.io/docs/api-reference/flows/text-to-speech/get.md
path: docs/api-reference/flows/text-to-speech/get
---
...
GET https://api.elevenlabs.io/v1/flows/text-to-speech/{generation_id}

Retrieve the status of a speech generation, and retrieve its output URL once completed.

Reference: https://elevenlabs.io/docs/api-reference/flows/text-to-speech/get
...
url = URI("https://api.elevenlabs.io/v1/flows/text-to-speech/generation_id")
...
HttpResponse<String> response = Unirest.get("https://api.elevenlabs.io/v1/flows/text-to-speech/generation_id")
  .asString();
```
...
$response = $client->request('GET', 'https://api.elevenlabs.io/v1/flows/text-to-speech/generation_id');
...
var client = new RestClient("https://api.elevenlabs.io/v1/flows/text-to-speech/generation_id");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.elevenlabs.io/v1/flows/text-to-speech/generation_id")! as URL,
