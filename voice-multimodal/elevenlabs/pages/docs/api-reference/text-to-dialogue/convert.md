...
source: https://elevenlabs.io/docs/api-reference/text-to-dialogue/convert.md
path: docs/api-reference/text-to-dialogue/convert
---
...
This endpoint expects a Body_Text_to_dialogue__multi_voice__v1_text_to_dialogue_post.
