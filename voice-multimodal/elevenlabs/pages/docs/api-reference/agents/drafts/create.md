      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: >-
                #/components/schemas/Body_Create_agent_draft_v1_convai_agents__agent_id__drafts_post
servers:
    ...
    WebhookToolApiSchemaConfig-Input:
      ...
      properties:
        ...
        method:
          ...
          default: GET
          description: The HTTP method to use for the webhook
        path_par> This is a page from the ElevenLabs documentation. For a complete page index, fetch https://elevenlabs.io/docs/llms.txt. For the full documentation in a single file, fetch https://elevenlabs.io/docs/llms-full.txt.
  ...
  schemas:
    ...
    Body_Create_agent_draft_v1_convai_agents__agent_id__drafts_post:
      ...
      required:
        ...
        - workflow
        - name
      title: Body_Create_agent_draft_v1_convai_agents__agent_id__drafts_post
