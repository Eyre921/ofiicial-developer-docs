...
This endpoint expects a Body_Create_agent_draft_v1_convai_agents__agent_id__drafts_post.
...
- `workflow` (AgentWorkflowRequestModel, required) — Workflow for the draft
