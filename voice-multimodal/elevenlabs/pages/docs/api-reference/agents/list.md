---
title: "List agents"
source: https://elevenlabs.io/docs/api-reference/agents/list.md
...
- `search` (string, optional, nullable) — Search by agents name.
...
- `agents` (list of AgentSummaryResponseModel, required) — A list of agents and their metadata
- `has_more` (boolean, required) — Whether there are more agents to paginate through
- `next_cursor` (string, optional, nullable) — The next cursor to paginate through the agents
...
func main() {
	...
	url := "https://api.elevenlabs.io/v1/convai/agents?archived=false&tags=%5B%22Customer+Support%22%5D"
...
url = URI("https://api.elevenlabs.io/v1/convai/agents?archived=false&tags=%5B%22Customer+Support%22%5D")
...
HttpResponse<String> response = Unirest.get("https://api.elevenlabs.io/v1/convai/agents?archived=false&tags=%5B%22Customer+Support%22%5D")
  .asString();
```
...
$response = $client->request('GET', 'https://api.elevenlabs.io/v1/convai/agents?archived=false&tags=%5B%22Customer+Support%22%5D');
...
var client = new RestClient("https://api.elevenlabs.io/v1/convai/agents?archived=false&tags=%5B%22Customer+Support%22%5D");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.elevenlabs.io/v1/convai/agents?archived=false&tags=%5B%22Customer+Support%22%5D")! as URL,
