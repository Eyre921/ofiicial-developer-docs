...
source: https://elevenlabs.io/docs/api-reference/agents/branches/get.md
path: docs/api-reference/agents/branches/get
---
...
Reference: https://elevenlabs.io/docs/api-reference/agents/branches/get
...
- `parent_branch` (AgentBranchBasicInfo, optional, nullable) — Parent branch of the branch
- `most_recent_versions` (list of AgentVersionMetadata, optional) — Most recent versions on the branch
