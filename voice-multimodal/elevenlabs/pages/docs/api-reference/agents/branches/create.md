...
This endpoint expects a Body_Create_a_new_branch_v1_convai_agents__agent_id__branches_post.
...
- `conversation_config` (map from string to any, optional, nullable) — Changes to apply to conversation config
- `platform_settings` (map from string to any, optional, nullable) — Changes to apply to platform settings
- `workflow` (AgentWorkflowRequestModel, optional, nullable) — Updated workflow definition
