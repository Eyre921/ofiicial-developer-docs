...
source: https://elevenlabs.io/docs/api-reference/agents/hold-audio/create.md
path: docs/api-reference/agents/hold-audio/create
---
...
Reference: https://elevenlabs.io/docs/api-reference/agents/hold-audio/create
...
```json
{
  "hold_audio_file": "<file: [object Object]>"
}
```
