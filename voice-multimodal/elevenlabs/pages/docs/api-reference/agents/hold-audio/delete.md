...
source: https://elevenlabs.io/docs/api-reference/agents/hold-audio/delete.md
path: docs/api-reference/agents/hold-audio/delete
---
...
Reference: https://elevenlabs.io/docs/api-reference/agents/hold-audio/delete
...
async function main() {
    ...
    await client.conversationalAi.agents.holdAudio.delete("agent_id");
}
main();
...
HttpResponse<String> response = Unirest.delete("https://api.elevenlabs.io/v1/convai/agents/agent_id/hold-audio")
  .asString();
```
...
$response = $client->request('DELETE', 'https://api.elevenlabs.io/v1/convai/agents/agent_id/hold-audio');
