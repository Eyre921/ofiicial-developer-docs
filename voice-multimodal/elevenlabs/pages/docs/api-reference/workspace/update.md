...
This endpoint expects a PatchConvAISettingsRequest.

- `conversation_initiation_client_data_webhook` (ConversationInitiationClientDataWebhook, optional, nullable)
