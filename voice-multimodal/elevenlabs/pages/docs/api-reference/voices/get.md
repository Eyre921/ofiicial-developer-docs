---
title: "Get voice"
source: https://elevenlabs.io/docs/api-reference/voices/get.md
path: docs/api-reference/voices/get
---
...
- `with_settings` (boolean, optional, default: true, deprecated) — This parameter is now deprecated. It is ignored and will be removed in a future version.
