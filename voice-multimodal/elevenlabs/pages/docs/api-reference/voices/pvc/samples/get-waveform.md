---
title: "Get PVC voice sample waveform"
source: https://elevenlabs.io/docs/api-reference/voices/pvc/samples/get-waveform.md
path: docs/api-reference/voices/pvc/samples/get-waveform
---
