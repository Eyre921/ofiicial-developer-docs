---
title: "Delete voice"
source: https://elevenlabs.io/docs/api-reference/voices/delete.md
path: docs/api-reference/voices/delete
---
...
- `status` (string, required) — The status of the voice deletion request. If the request was successful, the status will be 'ok'. Otherwise an error message with status 500 will be returned.
