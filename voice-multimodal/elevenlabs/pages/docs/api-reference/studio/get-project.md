...
- `chapters` (list of ChapterResponseModel, required) — List of chapters of the project and their metadata.
- `pronunciation_dictionary_versions` (list of PronunciationDictionaryVersionResponseModel, required) — List of pronunciation dictionary versions of the project and their metadata.
- `pronunciation_dictionary_locators` (list of PronunciationDictionaryLocatorResponseModel, required) — List of pronunciation dictionary locators.
...
- `assets` (list of ProjectExtendedResponseModelAssetsItems, required) — List of uploaded assets e.g. videos, audios.
- `voices` (list of ProjectVoiceResponseModel, required) — List of configured project voices.
...
- `base_voices` (list of VoiceResponseModel, optional, nullable) — List of voices used by the project.
- `publishing_read` (DirectPublishingReadResponseModel, optional, nullable) — The ElevenReader data if the book was published.
...
- `chapters` (list of ReadMetadataChapterDBModel, required)
...
- `legal_terms` (ReadLegalTerms, optional, nullable)
- `content_guidelines_terms` (ReadLegalTerms, optional, nullable)
...
- `contributors` (list of Contributor, optional, nullable)
...
- `preview_audio_object` (PreviewAudioDBModel, optional, nullable)
- `sample_config` (SampleConfigDBModel, optional, nullable)
- `review` (ReviewResponseModel, optional, nullable)
...
- `thumbnail_sheets` (list of ProjectVideoThumbnailSheetResponseModel, required)
...
- `pending_blocks_metadata` (PendingBlocksMetadataModel, optional, nullable)
- `pending_external_audios_metadata` (PendingExternalAudiosMetadataModel, optional, nullable)
- `speech_imported` (boolean, optional, default: false)
- `pending_task` (PendingClipTask, optional, nullable)
...
- `source_context` (GenerationSourceContext, optional, nullable)
- `analysis` (VideoAnalysis, optional, nullable)
- `transcription` (AssetTranscription, optional, nullable)
- `type` ("video", optional, default: video)
- `canvas_placement` (CanvasPlacement, optional) — Defines asset positioning and transformation on canvas.
...
- `error` (string, optional, nullable)
- `current_snapshot_id` (string, optional, nullable)
- `source_context` (ProjectExternalAudioResponseModelSourceContext, optional, nullable)
- `analysis` (AudioAnalysis, optional, nullable)
- `transcription` (AssetTranscription, optional, nullable)
...
- `error` (string, optional, nullable)
- `pending_task` (PendingClipTask, optional, nullable)
- `analysis` (ImageAnalysis, optional, nullable)
...
- `extend_video` (ReferenceVideo, optional, nullable)

### VideoAnalysis

- `status` (enum, required)
  - Allowed values: `processing`, `completed`, `failed`
- `data` (VideoAnalysisResult, required, nullable)
- `updated_at_ms` (integer, optional)
...
- `status` (enum, required)
  - Allowed values: `processing`, `completed`, `failed`
- `data` (AssetTranscriptionData, required, nullable)
- `updated_at_ms` (integer, optional)
...
- `status` (enum, required)
  - Allowed values: `processing`, `completed`, `failed`
- `data` (AudioAnalysisResult, required, nullable)
- `updated_at_ms` (integer, optional)
...
- `status` (enum, required)
  - Allowed values: `processing`, `completed`, `failed`
- `data` (ImageAnalysisResult, required, nullable)
- `updated_at_ms` (integer, optional)
...
- `studio_clip` (StudioClipLocator, optional, nullable) — Coordinates of a clip inside a Studio project: the payload of a studio_clip reference.
...
- `subjects` (list of VideoSubject, optional)
- `segments` (list of VideoSegment, optional)
- `key_moments` (list of VideoKeyMoment, optional)
...
- `content_type` (string, optional, nullable)
- `overall_pacing` (string, optional, nullable)
- `segments` (list of AudioSegment, optional)
- `key_moments` (list of AudioKeyMoment, optional)
...
- `subjects` (list of ImageSubject, optional)
