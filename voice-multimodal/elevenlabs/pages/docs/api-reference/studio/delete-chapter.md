...
source: https://elevenlabs.io/docs/api-reference/studio/delete-chapter.md
path: docs/api-reference/studio/delete-chapter
---
...
- `status` (string, required) — The status of the studio chapter deletion request. If the request was successful, the status will be 'ok'. Otherwise an error message with status 500 will be returned.
...
async function main() {
    ...
    await client.studio.projects.chapters.delete("chapter_id", "project_id");
}
main();
