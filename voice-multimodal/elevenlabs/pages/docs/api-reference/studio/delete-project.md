...
source: https://elevenlabs.io/docs/api-reference/studio/delete-project.md
path: docs/api-reference/studio/delete-project
---
...
- `status` (string, required) — The status of the studio project deletion request. If the request was successful, the status will be 'ok'. Otherwise an error message with status 500 will be returned.
