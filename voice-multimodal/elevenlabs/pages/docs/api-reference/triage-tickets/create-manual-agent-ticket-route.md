...
source: https://elevenlabs.io/docs/api-reference/triage-tickets/create-manual-agent-ticket-route.md
path: docs/api-reference/triage-tickets/create-manual-agent-ticket-route
---
...
Reference: https://elevenlabs.io/docs/api-reference/triage-tickets/create-manual-agent-ticket-route
...
let parameters = ["qa_comment": "string"] as [String : Any]
