...
This endpoint expects a Body_Submit_a_batch_call_request__v1_convai_batch_calling_submit_post.

- `call_name` (string, required)
- `agent_id` (string, required)
- `recipients` (list of OutboundCallRecipient, required)
- `scheduled_time_unix` (integer, optional, nullable)
- `agent_phone_number_id` (string, optional, nullable)
- `whatsapp_params` (BatchCallWhatsAppParams, optional, nullable)
...
- `whatsapp_params` (BatchCallWhatsAppParams, required, nullable)
...
- `telephony_call_config` (TelephonyCallConfig-Output, required)
