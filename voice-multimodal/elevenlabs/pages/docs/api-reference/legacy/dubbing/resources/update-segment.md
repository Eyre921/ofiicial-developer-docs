...
source: https://elevenlabs.io/docs/api-reference/legacy/dubbing/resources/update-segment.md
path: docs/api-reference/legacy/dubbing/resources/update-segment
---
...
Reference: https://elevenlabs.io/docs/api-reference/legacy/dubbing/resources/update-segment
...
async function main() {
    ...
    await client.dubbing.resource.segment.update("dubbing_id", "language", "segment_id", {});
}
main();
