...
source: https://elevenlabs.io/docs/api-reference/legacy/dubbing/delete.md
path: docs/api-reference/legacy/dubbing/delete
---
...
Reference: https://elevenlabs.io/docs/api-reference/legacy/dubbing/delete
...
- `status` (string, required) — The status of the dubbing project. If the request was successful, the status will be 'ok'. Otherwise an error message with status 500 will be returned.
