...
source: https://elevenlabs.io/docs/api-reference/legacy/voices/save-a-voice-preview.md
path: docs/api-reference/legacy/voices/save-a-voice-preview
---
