...
source: https://elevenlabs.io/docs/api-reference/mcp/tool-configuration/create.md
path: docs/api-reference/mcp/tool-configuration/create
---
...
This endpoint expects a MCPToolConfigOverrideCreateRequestModel.
...
- `tool_call_sound` (McpToolConfigOverrideCreateRequestModelToolCallSound, optional, nullable) — Overrides the server's tool_call_sound setting for this tool. A sound name plays that sound; 'off' overrides to no sound (silence); null means do not override (inherit the server default).
...
- `response_timeout_secs` (integer, optional, nullable) — If set, overrides the server's response timeout for this MCP tool.
- `assignments` (list of DynamicVariableAssignment, optional, nullable) — Dynamic variable assignments for this MCP tool
- `input_overrides` (map from string to McpToolConfigOverrideCreateRequestModelInputOverrides, optional, nullable) — Mapping of json path to input override configuration
