...
source: https://elevenlabs.io/docs/api-reference/mcp/tool-configuration/update.md
path: docs/api-reference/mcp/tool-configuration/update
---
...
This endpoint expects a MCPToolConfigOverrideUpdateRequestModel.
...
- `tool_call_sound` (McpToolConfigOverrideUpdateRequestModelToolCallSound, optional, nullable) — Overrides the server's tool_call_sound setting for this tool. A sound name plays that sound; 'off' overrides to no sound (silence); null means do not override (inherit the server default).
...
- `input_overrides` (map from string to McpToolConfigOverrideUpdateRequestModelInputOverrides, optional, nullable) — Mapping of json path to input override configuration
