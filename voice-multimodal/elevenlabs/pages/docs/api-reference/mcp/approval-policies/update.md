...
source: https://elevenlabs.io/docs/api-reference/mcp/approval-policies/update.md
path: docs/api-reference/mcp/approval-policies/update
---
...
This endpoint expects a MCPApprovalPolicyUpdateRequestModel.
...
let parameters = ["approval_policy": "require_approval_all"] as [String : Any]
