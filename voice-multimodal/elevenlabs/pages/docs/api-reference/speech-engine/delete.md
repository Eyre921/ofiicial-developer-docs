...
HttpResponse<String> response = Unirest.delete("https://api.elevenlabs.io/v1/speech-engine/seng_3701k3ttaq12ewp8b7qv5rfyszkz")
  .asString();
```
...
$response = $client->request('DELETE', 'https://api.elevenlabs.io/v1/speech-engine/seng_3701k3ttaq12ewp8b7qv5rfyszkz');
