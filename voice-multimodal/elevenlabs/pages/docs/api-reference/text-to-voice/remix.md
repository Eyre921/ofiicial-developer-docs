---
title: "Remix a voice"
source: https://elevenlabs.io/docs/api-reference/text-to-voice/remix.md
path: docs/api-reference/text-to-voice/remix
---
...
This endpoint expects a VoiceRemixRequestModel.

- `voice_description` (string, required) — Description of the changes to make to the voice.
