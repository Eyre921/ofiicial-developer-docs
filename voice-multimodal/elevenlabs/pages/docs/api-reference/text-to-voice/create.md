...
- `labels` (map from string to string, optional, nullable) — Optional, metadata to add to the created voice. Defaults to None.
- `played_not_selected_voice_ids` (list of string, optional, nullable) — List of voice ids that the user has played but not selected. Used for RLHF.
