...
- `phone_numbers` (list of GetPhoneNumbersPageResponseModelPhoneNumbersItems, required) — The phone numbers on this page
...
### GetPhoneNumbersPageResponseModelPhoneNumbersItems
