---
title: "Outbound call via twilio"
source: https://elevenlabs.io/docs/api-reference/integrations/twilio/outbound-call.md
path: docs/api-reference/integrations/twilio/outbound-call
---
...
Reference: https://elevenlabs.io/docs/api-reference/integrations/twilio/outbound-call
...
This endpoint expects a Body_Handle_an_outbound_call_via_Twilio_v1_convai_twilio_outbound_call_post.
...
- `call_recording_enabled` (boolean, optional, nullable) — Whether let Twilio record the call.
...
- `callSid` (string, required, nullable)
