...
source: https://elevenlabs.io/docs/api-reference/integrations/whats-app/outbound-message.md
path: docs/api-reference/integrations/whats-app/outbound-message
---
...
Reference: https://elevenlabs.io/docs/api-reference/integrations/whats-app/outbound-message
...
This endpoint expects a Body_Send_an_outbound_message_via_WhatsApp_v1_convai_whatsapp_outbound_message_post.

- `whatsapp_phone_number_id` (string, required)
- `whatsapp_user_id` (string, required)
- `template_name` (string, required)
- `template_language_code` (string, required)
- `template_params` (list of BodySendAnOutboundMessageViaWhatsAppV1ConvaiWhatsappOutboundMessagePostTemplateParamsItems, required)
- `agent_id` (string, required)
- `conversation_initiation_client_data` (ConversationInitiationClientDataRequest-Input, optional, nullable)
...
- `type`: `body` (WhatsAppTemplateBodyComponentParams)
  - `parameters` (list of WhatsAppTemplateTextParam, required)
- `type`: `button` (WhatsAppTemplateButtonComponentParams)
  - `index` (integer, required)
  - `parameters` (list of WhatsAppTemplateTextParam, required)
  - `sub_type` (string, required)
- `type`: `header` (WhatsAppTemplateHeaderComponentParams)
  - `parameters` (list of WhatsAppTemplateHeaderComponentParamsParametersItems, required)

### ConversationInitiationClientDataRequest-Input

- `conversation_config_override` (ConversationConfigClientOverride-Input, optional)
...
- `parameter_name` (string, optional, nullable)
- `type` ("text", optional, default: text)

### WhatsAppTemplateHeaderComponentParamsParametersItems

- `type`: `document` (WhatsAppTemplateDocumentParam)
  - `document` (WhatsAppTemplateDocumentParamDetails, required)
- `type`: `image` (WhatsAppTemplateImageParam)
  - `image` (WhatsAppTemplateImageParamDetails, required)
- `type`: `location` (WhatsAppTemplateLocationParam)
  - `location` (WhatsAppTemplateLocationParamDetails, required)
- `type`: `text` (WhatsAppTemplateTextParam)
  - `text` (string, required)
  - `parameter_name` (string, optional, nullable)
...
let parameters = [
  ...
  "template_name": "string",
  "template_language_code": "string",
  "template_params": [["parameters": [["text": "string"]]]],
  "agent_id": "string"
] as [String : Any]
