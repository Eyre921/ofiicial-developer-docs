...
source: https://elevenlabs.io/docs/api-reference/exotel/outbound-call.md
path: docs/api-reference/exotel/outbound-call
---
...
Reference: https://elevenlabs.io/docs/api-reference/exotel/outbound-call
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ExotelOutboundCallResponse'
        '422':
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: >-
                #/components/schemas/Body_Handle_an_outbound_call_via_Exotel_v1_convai_exotel_outbound_call_post
servers:
...
components:
  schemas:
    ...
    Body_Handle_an_outbound_call_via_Exotel_v1_convai_exotel_outbound_call_post:
      type: object
      properties:
        agent_id:
          type: string
      ...
      properties:
        ...
        callSid:
          type:
            - string
            - 'null'
          description: Exotel CallSid for the originated call
      required:
        - success
        - message
        - conversation_id
        - callSid
      title: ExotelOutboundCallResponse
...
{
  "success": true,
  "message": "Outbound call successfully initiated via Exotel.",
