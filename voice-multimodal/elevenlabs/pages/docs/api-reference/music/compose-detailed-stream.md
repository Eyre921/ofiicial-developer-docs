...
This endpoint expects a Body_Stream_composed_music_with_a_detailed_response_v1_music_detailed_stream_post.
...
- `composition_plan` (BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostCompositionPlan, optional, nullable) — A detailed composition plan to guide music generation. Cannot be used in conjunction with `prompt`.
