...
- `composition_plan` (BodyComposeMusicWithADetailedResponseV1MusicDetailedPostCompositionPlan, optional, nullable) — A detailed composition plan to guide music generation. Cannot be used in conjunction with `prompt`.
