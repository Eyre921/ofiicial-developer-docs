...
This endpoint expects a ListTestsByIdsRequestModel.
...
- `tests` (map from string to UnitTestSummaryResponseModel, required) — Dictionary mapping test IDs to their summary information
...
- `access_info` (ResourceAccessInfo, optional, nullable) — The access information of the test
