...
This endpoint expects a Body_Create_agent_test_folder_v1_convai_agent_testing_folders_post.

- `name` (string, required) — The name of the folder to create
- `parent_folder_id` (string, optional, nullable) — The ID of the parent folder. If not provided, the folder will be created at the root level.
