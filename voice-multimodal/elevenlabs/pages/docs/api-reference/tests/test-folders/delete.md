---
title: "Delete folder"
source: https://elevenlabs.io/docs/api-reference/tests/test-folders/delete.md
path: docs/api-reference/tests/test-folders/delete
---
...
Reference: https://elevenlabs.io/docs/api-reference/tests/test-folders/delete
