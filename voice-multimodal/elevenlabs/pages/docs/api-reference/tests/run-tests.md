...
- `agent_config_override` (object, optional, nullable) — Configuration overrides to use for testing. If not provided, the agent's default configuration will be used.
  ...
  - `workflow` (object, optional, nullable)
...
- `test_runs` (list of object, required)
  ...
  - `test_id` (string, required)
  - `test_info` (object, optional, nullable)
  ...
  - `workflow_node_id` (string, optional, nullable)
  - `agent_responses` (list of object, optional, nullable)
    - `role` (enum, required)
      - Allowed values: `user`, `agent`
    - `time_in_call_secs` (integer, required)
    - `agent_metadata` (object, optional, nullable)
  ...
  - `condition_result` (object, optional, nullable)
    - `result` (enum, required)
      - Allowed values: `success`, `failure`, `unknown`
    - `rationale` (object, optional, nullable) — Structured rationale for test condition results containing individual failure/success reasons.
