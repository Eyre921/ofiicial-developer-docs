---
title: "Get test"
source: https://elevenlabs.io/docs/api-reference/tests/get.md
path: docs/api-reference/tests/get
---
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/conversational_ai_tests_get_Response_200'
        '422':
...
components:
  schemas:
    ...
    LLM:
      ...
      title: LLM
    conversational_ai_tests_get_Response_200:
      oneOf:
        - type: object
          properties:
            type:
      ...
      discriminator:
        propertyName: type
      title: conversational_ai_tests_get_Response_200
