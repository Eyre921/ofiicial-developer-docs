...
source: https://elevenlabs.io/docs/api-reference/tests/test-invocations/resubmit.md
path: docs/api-reference/tests/test-invocations/resubmit
---
...
This endpoint expects a ResubmitTestsRequestModel.
