...
source: https://elevenlabs.io/docs/eleven-creative/audio-tools/voice-isolator.md
path: docs/eleven-creative/audio-tools/voice-isolator
---
...
<tbody>
  <tr>
    <td>
      ...
      For current pricing, see [ElevenCreative](https://elevenlabs.io/pricing?price.section=voice_isolator#pricing-table) and [ElevenAPI](https://elevenlabs.io/pricing/api).
  ...
  <tr>
    <td>
      ...
      [Voice Isolator](https://elevenlabs.io/app/voice-isolator) pricing depends on whether you generate via the website or the API.

      For current rates, see [ElevenCreative](https://elevenlabs.io/pricing?price.section=voice_isolator#pricing-table) and [ElevenAPI](https://elevenlabs.io/pricing/api).
    </td>
  </tr>
