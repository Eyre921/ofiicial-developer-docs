---
title: "What does 'The selected model can not be used for text to speech' mean?"
source: https://elevenlabs.io/docs/help-center/troubleshooting/what-does-the-selected-model-can-not-be-used-for-text-to-speech-mean.md
path: docs/help-center/troubleshooting/what-does-the-selected-model-can-not-be-used-for-text-to-speech-mean
---
