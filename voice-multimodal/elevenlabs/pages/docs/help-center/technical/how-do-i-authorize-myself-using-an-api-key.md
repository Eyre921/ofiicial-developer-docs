---
title: "How do I authorize myself using an API key?"
source: https://elevenlabs.io/docs/help-center/technical/how-do-i-authorize-myself-using-an-api-key.md
path: docs/help-center/technical/how-do-i-authorize-myself-using-an-api-key
---
...
You will only be able to see your API key in full when you first create it. After it has been created, you will only be able to see the name and final four characters. The full key will no longer be available to view.
