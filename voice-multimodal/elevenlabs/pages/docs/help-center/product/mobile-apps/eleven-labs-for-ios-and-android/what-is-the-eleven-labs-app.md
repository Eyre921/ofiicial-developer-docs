---
title: "What is the ElevenLabs App?"
source: https://elevenlabs.io/docs/help-center/product/mobile-apps/eleven-labs-for-ios-and-android/what-is-the-eleven-labs-app.md
path: docs/help-center/product/mobile-apps/eleven-labs-for-ios-and-android/what-is-the-eleven-labs-app
---

> This is a page from the ElevenLabs documentation. For a complete page index, fetch https://elevenlabs.io/docs/llms.txt. For the full documentation in a single file, fetch https://elevenlabs.io/docs/llms-full.txt.

# What is the ElevenLabs App?

The official ElevenLabs app allows you to access our most powerful voice tools from anywhere. The app is now available for both iOS and Android.
