---
title: "What can I do if I failed to verify my Professional Voice Clone (PVC)?"
source: https://elevenlabs.io/docs/help-center/product/voice-customization/voice-cloning/what-can-i-do-if-i-failed-to-verify-my-professional-voice-clone-pvc.md
path: docs/help-center/product/voice-customization/voice-cloning/what-can-i-do-if-i-failed-to-verify-my-professional-voice-clone-pvc
---
