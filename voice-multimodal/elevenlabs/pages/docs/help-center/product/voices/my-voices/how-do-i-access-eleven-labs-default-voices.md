...
If you are using the API, you can find the voice ID for Default voices in [My Voices](https://elevenlabs.io/app/voice-lab). Find the voice you want to use, then click the **More actions** (three dots) button and select **Copy voice ID** to copy the Voice ID to your clipboard.
