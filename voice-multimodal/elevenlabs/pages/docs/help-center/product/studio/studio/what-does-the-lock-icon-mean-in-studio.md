---
title: "What does the lock icon mean in Studio?"
source: https://elevenlabs.io/docs/help-center/product/studio/studio/what-does-the-lock-icon-mean-in-studio.md
path: docs/help-center/product/studio/studio/what-does-the-lock-icon-mean-in-studio
---
