...
source: https://elevenlabs.io/docs/help-center/product/speech-synthesis/speech-to-text/which-languages-does-speech-to-text-support.md
path: docs/help-center/product/speech-synthesis/speech-to-text/which-languages-does-speech-to-text-support
---
