...
Go to [Studio](https://elevenlabs.io/app/projects), and choose **Generate audio**. Select **Generate a podcast** from the available options, and you can then select options for your podcast.
