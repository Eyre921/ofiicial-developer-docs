...
You can connect **Client Tools**, **Webhooks**, or **System Tools** to your agent to enhance its functionality.

**Tools** allow your agent to interact with external data, systems, and the environment
...
**Webhooks** are tools that connect your assistant to external APIs. They’re ideal for
tasks like:
...
**Client Tools** interact directly with the user's browser or device where the agent is
...
**System Tools** are built-in and ready to use as soon as your agent is created. They
