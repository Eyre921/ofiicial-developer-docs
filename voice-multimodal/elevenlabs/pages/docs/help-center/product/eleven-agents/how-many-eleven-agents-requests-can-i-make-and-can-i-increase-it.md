---
title: "How many ElevenAgents requests can I make and can I increase it?"
source: https://elevenlabs.io/docs/help-center/product/eleven-agents/how-many-eleven-agents-requests-can-i-make-and-can-i-increase-it.md
path: docs/help-center/product/eleven-agents/how-many-eleven-agents-requests-can-i-make-and-can-i-increase-it
---

> This is a page from the ElevenLabs documentation. For a complete page index, fetch https://elevenlabs.io/docs/llms.txt. For the full documentation in a single file, fetch https://elevenlabs.io/docs/llms-full.txt.

# How many ElevenAgents requests can I make and can I increase it?

The concurrency limit (concurrent calls/conversations running in parallel) depends on your subscription.

For current concurrency limits for each subscription plan, see [ElevenAgents pricing](https://elevenlabs.io/pricing/agents).
