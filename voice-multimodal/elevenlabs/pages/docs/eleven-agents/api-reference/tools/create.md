---
title: "Create tool"
source: https://elevenlabs.io/docs/eleven-agents/api-reference/tools/create.md
path: docs/eleven-agents/api-reference/tools/create
---
  ...
  - `type`: `client`
    ...
    - `parameters` (object, optional) — Schema for any parameters to pass to the client
      ...
      - `properties` (map from string to object or object or object, optional)
        ...
        - Array JSON Schema Property Input
