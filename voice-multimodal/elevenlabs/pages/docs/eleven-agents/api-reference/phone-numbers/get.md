  ...
  schemas:
    ...
    type_:GetPhoneNumberOutboundSipTrunkConfigResponseModel:
      ...
      properties:
        ...
        username:
          type: string
          description: SIP trunk username (if > This is a page from the ElevenLabs documentation. For a complete page index, fetch https://elevenlabs.io/docs/llms.txt. For the full documentation in a single file, fetch https://elevenlabs.io/docs/llms-full.txt.
