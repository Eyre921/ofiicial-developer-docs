---
title: "Delete test"
source: https://elevenlabs.io/docs/eleven-agents/api-reference/tests/delete.md
path: docs/eleven-agents/api-reference/tests/delete
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/tests/delete
...
### 422 Tests Delete Request Unprocessable Entity Error
