...
- `include_folders` (boolean, optional, deprecated) — Deprecated. Use the `types` query param and include `folder` instead.
...
### 422 Tests List Request Unprocessable Entity Error
