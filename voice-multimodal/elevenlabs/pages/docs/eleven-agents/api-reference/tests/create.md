---
title: "Create test"
source: https://elevenlabs.io/docs/eleven-agents/api-reference/tests/create.md
path: docs/eleven-agents/api-reference/tests/create
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/tests/create
...
This endpoint expects a TestsCreateRequestBody.
...
- `TestsCreateRequestBody`
  - `type`: `llm`
    ...
    - `parent_folder_id` (string, optional) — The ID of the parent folder. If not provided, the test will be created at the root level.
