            ...
            schema:
              ...
              properties:
                ...
                response_timeout_secs:
                  type: integer
                  description: >-
                    The maximum time in seconds to wait for each MCP tool call
                    to complete.
                request_headers:
                  type: object
                ...
                request_meta:
                  ...
                  additionalProperties:
                    $ref: >-
                      #/components/schemas/type_conversationalAi/mcpServers:McpServerConfigUpdateRequestModelRequestMetaValue
                  description: >-
                    Entries sent in the MCP `_meta` field of tools/call
                    requests. Values may be JSON scalars, or references to a
                    workspace secret, dynamic variable, or environment variable
                    resolved per call.
                disable_compression:
                  type: boolean
                ...
                auth_connection:
                  $ref: >-
                    #/components/schemas/type_conversationalAi/mcpServers:McpServerConfigUpdateRequestModelAuthConnection
                  description: >-
...
components:
  schemas:
    ...
    type_conversationalAi/mcpServers:McpServerConfigUpdateRequestModelRequestMetaValue:
      oneOf:
        - type: string
        - type: integer
        - type: number
        ...
        - $ref: '#/components/schemas/type_:ConvAiDynamicVariable'
        - $ref: '#/components/schemas/type_:ConvAiEnvVarLocator'
      title: McpServerConfigUpdateRequestModelRequestMetaValue
    ...
    type_conversationalAi/mcpServers:McpServerConfigUpdateRequestModelAuthConnection:
      oneOf:
      ...
      title: McpServerConfigUpdateRequestModelAuthConnection
