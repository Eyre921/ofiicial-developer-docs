...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/mcp/get.md
path: docs/eleven-agents/api-reference/mcp/get
---
...
### 422 Mcp Servers Get Request Unprocessable Entity Error
