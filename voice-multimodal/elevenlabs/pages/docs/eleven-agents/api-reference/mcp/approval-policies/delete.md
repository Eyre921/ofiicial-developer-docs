...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/mcp/approval-policies/delete.md
path: docs/eleven-agents/api-reference/mcp/approval-policies/delete
---
...
- `tool_name` (string, required) — Name of the MCP tool to remove approval for.
...
### 422 Tool Approvals Delete Request Unprocessable Entity Error
