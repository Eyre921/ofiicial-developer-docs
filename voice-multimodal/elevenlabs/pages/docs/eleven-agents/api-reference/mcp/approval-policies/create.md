...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/mcp/approval-policies/create.md
path: docs/eleven-agents/api-reference/mcp/approval-policies/create
---
...
### 422 Tool Approvals Create Request Unprocessable Entity Error
