...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/mcp/tool-configuration/create.md
path: docs/eleven-agents/api-reference/mcp/tool-configuration/create
---
...
- `tool_call_sound` (McpToolConfigOverrideCreateRequestModelToolCallSound, optional) — Overrides the server's tool_call_sound setting for this tool. A sound name plays that sound; 'off' overrides to no sound (silence); null means do not override (inherit the server default).
...
- `response_timeout_secs` (integer, optional) — If set, overrides the server's response timeout for this MCP tool.
- `assignments` (list of DynamicVariableAssignment, optional) — Dynamic variable assignments for this MCP tool
- `input_overrides` (map from string to McpToolConfigOverrideCreateRequestModelInputOverridesValue, optional) — Mapping of json path to input override configuration
...
### 409 Tool Configs Create Request Conflict Error

Tool config override already exists

- `any`

### 422 Tool Configs Create Request Unprocessable Entity Error
...
func main() {
	...
	url := "https://api.elevenlabs.io/v1/convai/mcp-servers/mcp_server_id/tool-configs?environment=environment"
...
url = URI("https://api.elevenlabs.io/v1/convai/mcp-servers/mcp_server_id/tool-configs?environment=environment")
...
HttpResponse<String> response = Unirest.post("https://api.elevenlabs.io/v1/convai/mcp-servers/mcp_server_id/tool-configs?environment=environment")
...
$response = $client->request('POST', 'https://api.elevenlabs.io/v1/convai/mcp-servers/mcp_server_id/tool-configs?environment=environment', [
  'body' => '{
  "tool_name": "tool_name"
}',
  'headers' => [
...
var client = new RestClient("https://api.elevenlabs.io/v1/convai/mcp-servers/mcp_server_id/tool-configs?environment=environment");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.elevenlabs.io/v1/convai/mcp-servers/mcp_server_id/tool-configs?environment=environment")! as URL,
