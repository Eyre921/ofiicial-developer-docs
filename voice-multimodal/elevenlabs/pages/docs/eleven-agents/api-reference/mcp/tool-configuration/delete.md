...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/mcp/tool-configuration/delete.md
path: docs/eleven-agents/api-reference/mcp/tool-configuration/delete
---
...
- `tool_name` (string, required) — Name of the MCP tool to remove config overrides for.
...
### 422 Tool Configs Delete Request Unprocessable Entity Error
