...
- `conversation_config` (ConversationalConfig, optional) — Conversation configuration for an agent
...
- `phone_numbers` (list of GetAgentResponseModelPhoneNumbersItem, optional) — The phone numbers of the agent
