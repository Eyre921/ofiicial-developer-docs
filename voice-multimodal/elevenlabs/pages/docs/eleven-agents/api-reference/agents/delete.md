---
title: "Delete agent"
source: https://elevenlabs.io/docs/eleven-agents/api-reference/agents/delete.md
path: docs/eleven-agents/api-reference/agents/delete
---
...
### 422 Agents Delete Request Unprocessable Entity Error
