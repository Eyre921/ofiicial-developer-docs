...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/agents/calculate.md
path: docs/eleven-agents/api-reference/agents/calculate
---
...
- `prompt_length` (integer, optional) — Length of the prompt in characters.
- `number_of_pages` (integer, optional) — Pages of content in pdf documents OR urls in agent's Knowledge Base.
- `rag_enabled` (boolean, optional) — Whether RAG is enabled.
...
- `llm_prices` (list of LlmUsageCalculatorLlmResponseModel, required)

## Errors

### 422 Llm Usage Calculate Request Unprocessable Entity Error
...
- `price_per_message` (double, required)
