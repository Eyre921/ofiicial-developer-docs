...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/knowledge-base/delete.md
path: docs/eleven-agents/api-reference/knowledge-base/delete
---
...
- `force` (boolean, optional, default: false) — If set to true, the document or folder will be deleted regardless of whether it is used by any agents and it will be removed from the dependent agents. For non-empty folders, this will also delete all child documents and folders.
...
### 422 Documents Delete Request Unprocessable Entity Error
