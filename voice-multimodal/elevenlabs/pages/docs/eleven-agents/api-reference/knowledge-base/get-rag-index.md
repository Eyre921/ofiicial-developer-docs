---
title: "Get RAG index"
source: https://elevenlabs.io/docs/eleven-agents/api-reference/knowledge-base/get-rag-index.md
path: docs/eleven-agents/api-reference/knowledge-base/get-rag-index
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/knowledge-base/get-rag-index
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/type_:RagDocumentIndexesResponseModel'
        '422':
...
components:
  schemas:
    ...
    type_:RagDocumentIndexesResponseModel:
      type: object
      properties:
        indexes:
          type: array
