...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/knowledge-base/create-from-file.md
path: docs/eleven-agents/api-reference/knowledge-base/create-from-file
---
...
### 422 Documents Create from File Request Unprocessable Entity Error
