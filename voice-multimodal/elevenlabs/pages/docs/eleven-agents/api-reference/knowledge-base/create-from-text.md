...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/knowledge-base/create-from-text.md
path: docs/eleven-agents/api-reference/knowledge-base/create-from-text
---
...
### 422 Documents Create from Text Request Unprocessable Entity Error
