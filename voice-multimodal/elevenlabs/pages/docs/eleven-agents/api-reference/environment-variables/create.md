...
### 400 Environment Variables Create Request Bad Request Error

Invalid parameters

- `any`

### 409 Environment Variables Create Request Conflict Error

Environment variable with this label already exists

- `any`

### 422 Environment Variables Create Request Unprocessable Entity Error
