...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/integrations/exotel/outbound-call.md
path: docs/eleven-agents/api-reference/integrations/exotel/outbound-call
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/integrations/exotel/outbound-call
...
- `telephony_call_config` (TelephonyCallConfigInput, optional)
...
- `callSid` (string, optional) — Exotel CallSid for the originated call

## Errors

### 422 Exotel Outbound Call Request Unprocessable Entity Error
