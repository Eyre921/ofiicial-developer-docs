...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/integrations/whats-app/accounts/update.md
path: docs/eleven-agents/api-reference/integrations/whats-app/accounts/update
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/integrations/whats-app/accounts/update
...
- `enable_typing_indicator` (boolean, optional)
