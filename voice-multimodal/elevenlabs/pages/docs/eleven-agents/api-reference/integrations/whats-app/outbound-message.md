...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/integrations/whats-app/outbound-message.md
path: docs/eleven-agents/api-reference/integrations/whats-app/outbound-message
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/integrations/whats-app/outbound-message
...
- `template_params` (list of BodySendAnOutboundMessageViaWhatsAppV1ConvaiWhatsappOutboundMessagePostTemplateParamsItem, required)
- `agent_id` (string, required)
- `conversation_initiation_client_data` (ConversationInitiationClientDataRequestInput, optional)
...
- `type`: `header`
  - `parameters` (list of WhatsAppTemplateHeaderComponentParamsParametersItem, required)

### ConversationInitiationClientDataRequestInput

- `conversation_config_override` (ConversationConfigClientOverrideInput, optional)
