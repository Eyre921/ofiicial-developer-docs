...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/integrations/twilio/outbound-call.md
path: docs/eleven-agents/api-reference/integrations/twilio/outbound-call
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/integrations/twilio/outbound-call
...
- `call_recording_enabled` (boolean, optional) — Whether let Twilio record the call.
...
### 422 Twilio Outbound Call Request Unprocessable Entity Error
