...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/triage-tickets/create.md
path: docs/eleven-agents/api-reference/triage-tickets/create
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/triage-tickets/create
...
### 422 Triage Tickets Create Request Unprocessable Entity Error
