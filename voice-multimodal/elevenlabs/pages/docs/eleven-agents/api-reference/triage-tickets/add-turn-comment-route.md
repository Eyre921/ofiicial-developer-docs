...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/triage-tickets/add-turn-comment-route.md
path: docs/eleven-agents/api-reference/triage-tickets/add-turn-comment-route
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/triage-tickets/add-turn-comment-route
