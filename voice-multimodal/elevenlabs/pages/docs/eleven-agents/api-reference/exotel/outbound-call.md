...
source: https://elevenlabs.io/docs/eleven-agents/api-reference/exotel/outbound-call.md
path: docs/eleven-agents/api-reference/exotel/outbound-call
---
...
Reference: https://elevenlabs.io/docs/eleven-agents/api-reference/exotel/outbound-call
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/type_:ExotelOutboundCallResponse'
        '422':
...
components:
  schemas:
    ...
    type_:ExotelOutboundCallResponse:
      type: object
      properties:
        success:
          type: boolean
