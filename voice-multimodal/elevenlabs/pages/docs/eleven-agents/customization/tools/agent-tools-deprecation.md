...
source: https://elevenlabs.io/docs/eleven-agents/customization/tools/agent-tools-deprecation.md
path: docs/eleven-agents/customization/tools/agent-tools-deprecation
---
