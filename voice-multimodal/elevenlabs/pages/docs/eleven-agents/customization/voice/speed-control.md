---
title: "Speed control"
source: https://elevenlabs.io/docs/eleven-agents/customization/voice/speed-control.md
path: docs/eleven-agents/customization/voice/speed-control
---
