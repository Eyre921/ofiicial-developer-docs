...
source: https://elevenlabs.io/docs/eleven-agents/customization/voice/expressive-mode.md
path: docs/eleven-agents/customization/voice/expressive-mode
---
