...
source: https://elevenlabs.io/docs/eleven-agents/customization/events/client-to-server-events.md
path: docs/eleven-agents/customization/events/client-to-server-events
---
