...
If your site sits behind a CDN, WAF, or bot-protection rule, allow this user agent so the crawler
can read your pages. When a request is blocked, the document is created but no content can be
extracted from it.
