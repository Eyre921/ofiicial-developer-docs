...
source: https://elevenlabs.io/docs/overview/capabilities/private-deployment.md
path: docs/overview/capabilities/private-deployment
---
...
Run the full ElevenAgents runtime in your VPC, connected to your own LLM, telephony and
retrieval.

#### State-of-the-art models

Access to ElevenLabs' v2 and v2.5 Text to Speech models and Scribe V2 for transcription.

#### Complete data control

All text, audio and call data stays within your infrastructure, meeting strict compliance and
data residency requirements.

#### Enterprise support

Forward-deployed engineers, reference architectures and sizing guidance throughout the rollout.
...
If you already have access, start with [Getting started](/docs/private-deployment/getting-started).
