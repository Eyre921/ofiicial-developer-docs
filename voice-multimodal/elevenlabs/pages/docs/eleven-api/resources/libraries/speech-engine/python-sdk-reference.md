...
source: https://elevenlabs.io/docs/eleven-api/resources/libraries/speech-engine/python-sdk-reference.md
path: docs/eleven-api/resources/libraries/speech-engine/python-sdk-reference
---
...
| `disable_auth`  | `bool`     | `False` | Skip JWT verification on incoming connections. See [Disabling authentication](#disabling-authentication). |
