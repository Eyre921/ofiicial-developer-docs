...
source: https://elevenlabs.io/docs/eleven-api/guides/cookbooks/music.md
path: docs/eleven-api/guides/cookbooks/music
---
...
Generate a track and save it to a file:
...
Open `music.mp3` to hear the result.
