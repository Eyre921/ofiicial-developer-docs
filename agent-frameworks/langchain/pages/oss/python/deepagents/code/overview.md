...
* <Icon icon="target-arrow" /> **[Goals and rubrics](/oss/python/deepagents/code/goals-and-rubrics)** - define measurable objectives or grading criteria so the agent can check whether work is done.
