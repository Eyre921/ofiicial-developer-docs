...
path: oss/python/deepagents/code/memory-and-skills
---
...
When duplicate skill names exist, later-precedence directories override earlier ones (see [App data](/oss/python/deepagents/code/configuration#skills)).
