...
source: https://docs.langchain.com/oss/python/deepagents/code/approval-modes
path: oss/python/deepagents/code/approval-modes
---
...
* The active model is not an independent security authority. [MCP read-only annotations](/oss/python/deepagents/code/mcp-tools#read-only-tool-annotations-in-auto-mode) are trusted as a deliberate beta tradeoff.
