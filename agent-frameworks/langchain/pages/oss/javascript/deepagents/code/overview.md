...
* <Icon icon="file" /> **File operations** - read, write, edit, and delete files on disk.
...
* <Icon icon="target-arrow" /> **[Goals and rubrics](/oss/javascript/deepagents/code/goals-and-rubrics)** - define measurable objectives or grading criteria so the agent can check whether work is done.
