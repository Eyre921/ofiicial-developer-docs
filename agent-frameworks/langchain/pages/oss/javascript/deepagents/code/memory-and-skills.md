...
path: oss/javascript/deepagents/code/memory-and-skills
---
...
When duplicate skill names exist, later-precedence directories override earlier ones (see [App data](/oss/javascript/deepagents/code/configuration#skills)).
