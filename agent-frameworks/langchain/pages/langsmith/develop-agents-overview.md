...
path: langsmith/develop-agents-overview
---
...
<CardGroup>
  <Card title="Develop your application" href="/langsmith/application-structure" icon="code">
  ...
  <Card title="Agent Server runtime" href="/langsmith/agent-server" icon="bolt">
  ...
  <Card title="Auth & access control" href="/langsmith/auth" icon="lock">
    Authenticate users, enforce resource-level access, and connect external OAuth2 identity providers.
  </Card>

  <Card title="Server customization" href="/langsmith/caching" icon="settings">
