...
source: https://docs.langchain.com/langsmith/smith-api/v2/query-single-thread-stats
path: langsmith/smith-api/v2/query-single-thread-stats
---

/langsmith/langsmith-platform-openapi.json get /v2/threads/{thread_id}/stats
