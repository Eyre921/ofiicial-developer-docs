---
title: "Query runs"
source: https://docs.langchain.com/langsmith/smith-api/v2/query-runs
path: langsmith/smith-api/v2/query-runs
---

/langsmith/langsmith-platform-openapi.json post /v2/runs/query
