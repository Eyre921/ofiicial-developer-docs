---
title: "Query public shared trace runs (v2)"
source: https://docs.langchain.com/langsmith/smith-api/runs/query-public-shared-trace-runs-v2
path: langsmith/smith-api/runs/query-public-shared-trace-runs-v2
---
