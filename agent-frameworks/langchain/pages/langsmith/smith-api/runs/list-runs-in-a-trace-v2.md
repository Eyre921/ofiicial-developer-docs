---
title: "List runs in a trace (v2)"
source: https://docs.langchain.com/langsmith/smith-api/runs/list-runs-in-a-trace-v2
path: langsmith/smith-api/runs/list-runs-in-a-trace-v2
---
