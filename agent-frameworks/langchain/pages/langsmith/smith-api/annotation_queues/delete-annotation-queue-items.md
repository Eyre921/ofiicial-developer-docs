...
path: langsmith/smith-api/annotation_queues/delete-annotation-queue-items
---

/langsmith/langsmith-platform-openapi.json post /api/v1/annotation-queues/{queue_id}/items/delete
