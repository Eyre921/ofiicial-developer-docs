...
path: langsmith/smith-api/annotation_queues/list-annotation-queue-items
---

/langsmith/langsmith-platform-openapi.json get /api/v1/annotation-queues/{queue_id}/items
