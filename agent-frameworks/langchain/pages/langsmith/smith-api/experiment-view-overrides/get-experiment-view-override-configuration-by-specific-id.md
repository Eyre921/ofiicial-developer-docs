...
path: langsmith/smith-api/experiment-view-overrides/get-experiment-view-override-configuration-by-specific-id
---

/langsmith/langsmith-platform-openapi.json get /v1/platform/datasets/{dataset_id}/experiment-view-overrides/{id}
