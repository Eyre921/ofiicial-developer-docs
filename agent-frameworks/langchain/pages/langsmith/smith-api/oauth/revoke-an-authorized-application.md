...
path: langsmith/smith-api/oauth/revoke-an-authorized-application
---

/langsmith/langsmith-platform-openapi.json delete /v1/platform/oauth/authorized-apps/{clientID}
