...
path: langsmith/python/managed-deep-agents-instructions
---
...
When you run `mda deploy`, MDA syncs `instructions.md` to the agent's [Context Hub](/langsmith/python/managed-deep-agents-context-hub).
