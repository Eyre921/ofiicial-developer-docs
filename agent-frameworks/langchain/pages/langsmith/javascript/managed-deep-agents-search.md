...
source: https://docs.langchain.com/langsmith/javascript/managed-deep-agents-search
path: langsmith/javascript/managed-deep-agents-search
---

[Managed Deep Agents](/langsmith/javascript/managed-deep-agents-overview) includes built-in web search powered by [Parallel](https://parallel.ai). Give your agent access to current information from the web to help answer questions.
...
You need an existing [Managed Deep Agents project](/langsmith/javascript/managed-deep-agents-quickstart), your LangSmith workspace ID, and a personal LangSmith API key for use in Studio.
