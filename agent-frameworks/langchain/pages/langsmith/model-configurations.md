...
path: langsmith/model-configurations
---
...
1. Navigate to **Settings** > **Model configurations** and either click **+ Create** or open an existing row through the overflow menu <Icon icon="dots-vertical" /> > **Edit**.
