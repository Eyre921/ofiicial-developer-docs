---
title: "Memory"
source: https://docs.crewai.com/v1.15.11/en/concepts/memory
path: v1.15.11/en/concepts/memory
---
...
* **insert\_new** -- Whether the new content should also be inserted as a separate record.
