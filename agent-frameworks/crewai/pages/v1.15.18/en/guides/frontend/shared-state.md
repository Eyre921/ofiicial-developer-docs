---
title: "Shared State"
source: https://docs.crewai.com/v1.15.18/en/guides/frontend/shared-state
path: v1.15.18/en/guides/frontend/shared-state
---

Keep your CrewAI agent's state and your app's UI in two-way sync, so edits on either side flow to the other.
