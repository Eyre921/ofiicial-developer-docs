...
source: https://docs.crewai.com/v1.15.8/en/enterprise/guides/custom-mcp-server
path: v1.15.8/en/enterprise/guides/custom-mcp-server
---
...
<Frame>
  <img alt="Custom MCP Server with Authentication Token" />
</Frame>
...
<Frame>
  <img alt="Custom MCP Server with OAuth 2.0" />
</Frame>
