...
source: https://docs.crewai.com/v1.15.15/en/concepts/agent-capabilities
path: v1.15.15/en/concepts/agent-capabilities
---
...
<CardGroup>
  ...
  <Card title="MCP Servers" icon="plug" href="/en/mcp/overview">
