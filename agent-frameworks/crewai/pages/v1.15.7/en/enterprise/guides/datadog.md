...
source: https://docs.crewai.com/v1.15.7/en/enterprise/guides/datadog
path: v1.15.7/en/enterprise/guides/datadog
---
...
<Tabs>
  ...
  <Tab title="Datadog OTLP intake">
    ...
    **Setup:**
    ...
    <Frame>
      <img alt="Datadog collector configuration" />
    </Frame>
...
| **Drill-Down** | *(empty placeholder)*                                                                   | See [Customization](#customize) for adding a recent-errors log stream here.                                                  |
