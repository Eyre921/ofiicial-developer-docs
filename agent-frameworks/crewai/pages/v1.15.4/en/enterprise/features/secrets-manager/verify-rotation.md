...
source: https://docs.crewai.com/v1.15.4/en/enterprise/features/secrets-manager/verify-rotation
path: v1.15.4/en/enterprise/features/secrets-manager/verify-rotation
---
...
```python src/rotation_verifier/tools/credential_echo_tool.py theme={null}
...
```yaml src/rotation_verifier/config/agents.yaml theme={null}
credential_checker:
  role: >
    Credential Verifier
  goal: >
...
```yaml src/rotation_verifier/config/tasks.yaml theme={null}
...
```python src/rotation_verifier/crew.py theme={null}
