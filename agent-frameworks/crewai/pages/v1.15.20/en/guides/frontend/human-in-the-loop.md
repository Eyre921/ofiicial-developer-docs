...
source: https://docs.crewai.com/v1.15.20/en/guides/frontend/human-in-the-loop
path: v1.15.20/en/guides/frontend/human-in-the-loop
---

Pause your CrewAI agent mid-run to collect a user decision, then resume the agent with their answer.
