...
source: https://docs.crewai.com/v1.15.20/en/learn/execution-boundary-hooks
path: v1.15.20/en/learn/execution-boundary-hooks
---

Intercept the start, inputs, output, and end of crew and flow executions with the @on decorator
