...
source: https://docs.crewai.com/v1.15.2/en/enterprise/guides/capture_telemetry_logs
path: v1.15.2/en/enterprise/guides/capture_telemetry_logs
---
...
<Tabs>
  <Tab title="OpenTelemetry Traces / Logs">
    ...
    * **Certificate** *(optional)* — Provide a TLS certificate if your collector requires one.
    ...
    <Frame>
      <img alt="OpenTelemetry collector configuration" />
    </Frame>
  </Tab>
