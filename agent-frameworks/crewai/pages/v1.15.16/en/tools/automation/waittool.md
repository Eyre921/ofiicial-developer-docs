---
title: "Wait Tool"
source: https://docs.crewai.com/v1.15.16/en/tools/automation/waittool
path: v1.15.16/en/tools/automation/waittool
---

The `WaitTool` lets an agent pause before checking a long-running job again.
