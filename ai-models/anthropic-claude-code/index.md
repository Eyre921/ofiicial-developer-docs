...
- `settings` — [Settings files and precedence](pages/settings.md) · [原文](https://code.claude.com/docs/en/settings)
- `settings-example` — [Example settings files](pages/settings-example.md) · [原文](https://code.claude.com/docs/en/settings-example)
- `settings-reference` — [All settings](pages/settings-reference.md) · [原文](https://code.claude.com/docs/en/settings-reference)
