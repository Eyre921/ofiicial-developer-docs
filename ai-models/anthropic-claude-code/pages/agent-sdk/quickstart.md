...
| `bypassPermissions`      | Runs every tool without prompting, unless an explicit [`ask` rule](/docs/en/agent-sdk/permissions#how-permissions-are-evaluated) matches | Sandboxed CI, fully trusted environments  |
