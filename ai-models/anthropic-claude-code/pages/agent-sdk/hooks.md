...
| [`UserPromptExpansion`](/docs/en/hooks#userpromptexpansion) | No         | Yes            | A user-typed command expands into a prompt before it reaches Claude                   | Block a command from direct invocation or add context when a skill is typed |
