...
<span /><sup>1</sup> On Vertex AI, web search is available for Claude 4 models and later.<br />
<span /><sup>2</sup> Requires `CLAUDE_CODE_ENABLE_AUTO_MODE`. See [Auto mode configuration](/docs/en/auto-mode-config).<br />
...
<Tabs>
  ...
  <Tab title="Claude Platform on AWS">
    ...
    **Available** where Bedrock is not: [web search](/docs/en/tools-reference#websearch-tool-behavior), [auto mode](/docs/en/auto-mode-config) without an opt-in flag, and [`/loop` self-pacing](/docs/en/scheduled-tasks).
