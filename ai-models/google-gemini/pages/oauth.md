---
title: "Authentication with OAuth quickstart"
source: https://ai.google.dev/gemini-api/docs/oauth.md
path: oauth
---

The easiest way to authenticate to the Gemini API is to configure an API
key, as described in the [Gemini API get started
guide](https://ai.google.dev/gemini-api/docs/get-started). If you need stricter access controls,
