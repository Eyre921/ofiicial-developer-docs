...
[pricing](https://ai.google.dev/gemini-api/docs/generate-content/file-search#pricing) section for details.
...
method, as shown in the [Upload](https://ai.google.dev/gemini-api/docs/generate-content/file-search#upload) and [Import](https://ai.google.dev/gemini-api/docs/generate-content/file-search#importing-files) examples.
...
[Directly upload to File Search store](https://ai.google.dev/gemini-api/docs/generate-content/file-search#upload) or [Importing files](https://ai.google.dev/gemini-api/docs/generate-content/file-search#importing-files).
