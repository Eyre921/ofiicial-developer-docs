...
- **Function Calling (Strict):** The API enforces strict validation on the
  ...
  > [!NOTE]
  > **Note:** Circulation of thought signatures is required even when [thinking level](https://ai.google.dev/gemini-api/docs/generate-content/gemini-3#thinking_level) is set to `minimal` for Gemini 3 Flash.
