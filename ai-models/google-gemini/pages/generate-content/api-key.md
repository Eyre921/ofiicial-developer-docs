...
- **On September 2026** : the Gemini API will reject requests from **Standard
  keys** . You must [migrate to auth keys](https://ai.google.dev/gemini-api/docs/generate-content/api-key#migrate-to-auth-key) before this date to avoid service interruption. Make sure to migrate to auth keys before September 2026.
...
> [!NOTE]
> **Note:** If you don't see your keys, you may need to import your Cloud projects into AI Studio. Refer to the [import projects](https://ai.google.dev/gemini-api/docs/generate-content/api-key#import-projects) section for instructions.
