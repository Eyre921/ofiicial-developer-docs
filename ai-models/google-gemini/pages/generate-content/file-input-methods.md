...
[Input method comparison table](https://ai.google.dev/gemini-api/docs/generate-content/file-input-methods#method-comparison) for a complete list of file
...
- File size limits vary by method (see [comparison table](https://ai.google.dev/gemini-api/docs/generate-content/file-input-methods#method-comparison)) and file type.
