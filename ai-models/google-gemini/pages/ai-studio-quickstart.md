...
source: https://ai.google.dev/gemini-api/docs/ai-studio-quickstart.md
path: ai-studio-quickstart
---
...
use the [Gemini API](https://ai.google.dev/gemini-api/docs/get-started).
...
- If you're ready to move on to code, see the [API
  Get started guides](https://ai.google.dev/gemini-api/docs/get-started).
