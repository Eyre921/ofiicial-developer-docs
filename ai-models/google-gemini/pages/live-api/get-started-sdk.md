---
title: "Get started with Gemini Live API using the Google GenAI SDK"
source: https://ai.google.dev/gemini-api/docs/live-api/get-started-sdk.md
path: live-api/get-started-sdk
---
