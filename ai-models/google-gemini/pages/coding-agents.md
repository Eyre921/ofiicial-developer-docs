...
source: https://ai.google.dev/gemini-api/docs/coding-agents.md
path: coding-agents
---
...
[Interactions API](https://ai.google.dev/gemini-api/docs/interactions-overview). The Interactions API is a
