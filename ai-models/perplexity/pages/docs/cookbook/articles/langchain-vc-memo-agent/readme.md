...
path: docs/cookbook/articles/langchain-vc-memo-agent/readme
---
...
<img alt="Company name flows into START, fans out to four parallel research nodes (team, financials, product, market), which all feed a single synthesizer node that produces the memo at END." />
...
A memo takes about ninety seconds and costs roughly \$0.40. With `LANGSMITH_TRACING="true"`, the full run appears in LangSmith with every node's tool calls. Here is a [public trace of one run](https://smith.langchain.com/public/b14e0e98-0f1d-478f-96ce-2662fab6a085/r/019ea8ee-4e5e-7081-8cec-a5879c871505) to explore.

<img alt="A LangSmith trace for one memo run: the four parallel research nodes feed the synthesizer, and the memo output shows its Citations section with primary-source URLs." />
...
<img alt="A LangSmith comparison of the Perplexity, Parallel, and Exa experiments across feedback scores, latency, and cost." />
