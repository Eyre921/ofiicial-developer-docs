...
source: https://docs.perplexity.ai/docs/cookbook/getting-started
path: docs/cookbook/getting-started
---

How to use the Perplexity API Cookbook, plus a quick start for getting your API key and installing the SDK.
