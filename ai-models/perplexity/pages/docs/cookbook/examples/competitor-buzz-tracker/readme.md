...
path: docs/cookbook/examples/competitor-buzz-tracker/readme
---
...
<Frame>
  <img alt="Competitor Buzz Tracker PDF: horizontal bar chart of news mentions for Galaxy, iPhone, Pixel, and Other, each labeled with its total and share of voice." />
