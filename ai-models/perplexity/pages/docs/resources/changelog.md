...
<Update label="April 2026">
  **Agent API: New Third-Party Models**
  ...
  The Agent API now supports Claude Opus 4.7, GPT-5.5, and Grok 4.20 Reasoning — extending model choice for tool-calling, structured outputs, and fallback chains. See the full list in the [Agent API Models reference](/docs/agent-api/models).
