...
path: docs/sonar/models/sonar-deep-research
---
  ...
  <div>
    <div>
      <div>
        ...
        <div>
          <div>
            <h1>Sonar Deep Research</h1>
            <p>Exhaustive research with expert-level insights</p>
          </div>
        </div>
      </div>
    ...
    <div>
      <div>
        <div>
          ...
          <div>
            <h3>Deep research / Reasoning model</h3>
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <h3>Exhaustive research across hundreds of sources</h3>
          </div>
        </div>
      ...
      <div>
        <div>
          ...
          <div>
            <h3>Expert-level subject analysis</h3>
          </div>
        </div>
  ...
  <div>
    ...
    <div>
      <div>
        ...
        <div>
          <h3>Academic research and comprehensive reports</h3>
        </div>
      </div>

      <div>
        <div>
          <img alt="Market Analysis" />
        </div>

        <div>
          <h3>Market analysis and competitive intelligence</h3>
        </div>
      </div>

      <div>
        <div>
          <img alt="Due Diligence" />
        </div>

        <div>
          <h3>Due diligence and investigative research</h3>
        </div>
      </div>
    </div>
  </div>
        ...
        * `"high"`: Deeper, more thorough responses with increased token usage
        ...
        <CodeGroup>
          ...
          payload = {
              "model": "sonar-deep-research",
              "messages": [
                  {"role": "user", "content": "Provide an exhaustive analysis of current approaches to achieving net-zero carbon emissions in heavy industry, including technological solutions, policy frameworks, and economic feasibility across different sectors."}
              ],
              "reasoning_effort": "low"
          }
          headers = {
        ...
        <Steps>
          <Step title="Submit Request">
            <CodeGroup>
              ...
              curl --location 'https://api.perplexity.ai/v1/async/sonar' \
              --header 'Authorization: Bearer <token>' \
              --header 'Content-Type: application/json' \
              --data '{
                "request": {
          ...
          <Step title="Retrieve Results">
            <CodeGroup>
              ```bash cURL wrap theme={null}
              curl --location 'https://api.perplexity.ai/v1/async/sonar/{REPLACE_WITH_REQUEST_ID}' \
                --header "Authorization: Bearer <token>"
              ```
              ...
              request_id = "784312ac-b8fd-405f-99fa-9bcbf48865bb" # Replace with your request ID
              url = f"https://api.perplexity.ai/v1/async/sonar/{request_id}"
              ...
              ```python Poll Until Completion theme={null}
              import requests
              import time
