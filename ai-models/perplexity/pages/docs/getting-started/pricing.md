...
path: docs/getting-started/pricing
---
...
<CardGroup>
  <Card title="Perplexity API Platform on AWS Marketplace" icon="aws" href="/docs/resources/aws-marketplace">
    Purchase API credits through AWS Marketplace with consolidated billing and enterprise procurement.
  </Card>

  <Card title="Contact Sales Team" icon="file-pencil" href="https://perplexity.typeform.com/to/nXeehCGo">
