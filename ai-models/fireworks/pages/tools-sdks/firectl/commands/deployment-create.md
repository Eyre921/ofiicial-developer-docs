...
```
      --accelerator-count int32                  The number of accelerators to use per replica. Only use together with --deployment-shape (see warning above); setting it without a shape skips validation.
  ...
  -h, --help                                     help for create
      ...
      --max-replica-count int32                  Maximum number of replicas for the deployment. If min-replica-count > 0 defaults to 0, # Data residency
