...
source: https://docs.fireworks.ai/tools-sdks/firectl/commands/rlor-trainer-job-list
path: tools-sdks/firectl/commands/rlor-trainer-job-list
---

Lists all rlor trainer jobs in an account.
