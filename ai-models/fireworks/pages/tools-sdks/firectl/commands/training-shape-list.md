...
source: https://docs.fireworks.ai/tools-sdks/firectl/commands/training-shape-list
path: tools-sdks/firectl/commands/training-shape-list
---

Lists training shapes in the account.
