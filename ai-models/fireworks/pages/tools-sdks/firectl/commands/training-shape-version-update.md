...
source: https://docs.fireworks.ai/tools-sdks/firectl/commands/training-shape-version-update
path: tools-sdks/firectl/commands/training-shape-version-update
---
...
```
  ...
  -o, --output Output   Set the output format to "text", "json", or "flag". (default text)
      --public          Will set the version as public.
```
