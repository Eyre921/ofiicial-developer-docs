---
title: "There’s a model I would like to use that isn’t available on Fireworks. Can I request it?"
...
path: faq-new/models-inference/theres-a-model-i-would-like-to-use-that-isnt-available-on-fireworks-can-i-reques
---
