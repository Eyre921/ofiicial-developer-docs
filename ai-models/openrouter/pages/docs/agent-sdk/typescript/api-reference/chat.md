...
source: https://openrouter.ai/docs/agent-sdk/typescript/api-reference/chat.md
path: docs/agent-sdk/typescript/api-reference/chat
---
...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------ | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.SendChatCompletionRequestRequest](/docs/agent-sdk/typescript/api-reference/operations/sendchatcompletionrequestrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.SendChatCompletionRequestResponse](/docs/agent-sdk/typescript/api-reference/operations/sendchatcompletionrequestresponse)>**
