...
source: https://openrouter.ai/docs/agent-sdk/typescript/api-reference/rerank.md
path: docs/agent-sdk/typescript/api-reference/rerank
---
...
| ---------------------- | ---------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.CreateRerankRequest](/docs/agent-sdk/typescript/api-reference/operations/creatererankrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.CreateRerankResponse](/docs/agent-sdk/typescript/api-reference/operations/creatererankresponse)>**
