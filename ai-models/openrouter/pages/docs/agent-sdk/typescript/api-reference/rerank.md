...
| ---------------------- | ---------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.CreateRerankRequest](/agent-sdk/typescript/api-reference/operations/creatererankrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |
