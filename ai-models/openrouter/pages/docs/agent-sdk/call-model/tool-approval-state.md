...
source: https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state.md
path: docs/agent-sdk/call-model/tool-approval-state
---
...
If a conversation was interrupted > ## Documentation Index
> Fetch the complete documentation index at: https://openrouter.ai/docs/llms.txt
> Use this file to discover all available pages before exploring further.
