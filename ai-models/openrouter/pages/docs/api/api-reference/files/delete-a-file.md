---
title: "Delete a file"
source: https://openrouter.ai/docs/api/api-reference/files/delete-a-file.md
path: docs/api/api-reference/files/delete-a-file
---
...
````yaml /openapi/openapi.yaml delete /files/{file_id}
openapi: 3.1.0
info:
  contact:
