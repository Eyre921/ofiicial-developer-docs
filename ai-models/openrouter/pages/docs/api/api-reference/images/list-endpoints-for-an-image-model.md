...
source: https://openrouter.ai/docs/api/api-reference/images/list-endpoints-for-an-image-model.md
path: docs/api/api-reference/images/list-endpoints-for-an-image-model
---
