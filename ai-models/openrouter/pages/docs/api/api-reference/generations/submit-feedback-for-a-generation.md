...
source: https://openrouter.ai/docs/api/api-reference/generations/submit-feedback-for-a-generation.md
path: docs/api/api-reference/generations/submit-feedback-for-a-generation
---
...
````yaml /openapi/openapi.yaml post /generation/feedback
openapi: 3.1.0
info:
  contact:
