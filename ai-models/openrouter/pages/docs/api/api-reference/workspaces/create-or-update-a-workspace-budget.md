...
source: https://openrouter.ai/docs/api/api-reference/workspaces/create-or-update-a-workspace-budget.md
path: docs/api/api-reference/workspaces/create-or-update-a-workspace-budget
---
