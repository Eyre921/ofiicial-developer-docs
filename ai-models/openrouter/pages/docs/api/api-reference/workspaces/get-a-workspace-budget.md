...
source: https://openrouter.ai/docs/api/api-reference/workspaces/get-a-workspace-budget.md
path: docs/api/api-reference/workspaces/get-a-workspace-budget
---
...
````yaml /openapi/openapi.yaml get /workspaces/{workspace_ref}/budgets/{interval}
openapi: 3.1.0
info:
  contact:
