...
source: https://openrouter.ai/docs/api/api-reference/analytics/get-available-analytics-metrics-and-dimensions.md
path: docs/api/api-reference/analytics/get-available-analytics-metrics-and-dimensions
---
