...
source: https://openrouter.ai/docs/api/api-reference/embeddings/submit-an-embedding-request.md
path: docs/api/api-reference/embeddings/submit-an-embedding-request
---
