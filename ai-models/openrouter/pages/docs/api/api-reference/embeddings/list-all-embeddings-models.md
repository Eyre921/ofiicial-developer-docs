...
source: https://openrouter.ai/docs/api/api-reference/embeddings/list-all-embeddings-models.md
path: docs/api/api-reference/embeddings/list-all-embeddings-models
---
