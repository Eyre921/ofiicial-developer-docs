---
title: "Get a SCIM group mapping"
source: https://openrouter.ai/docs/api/api-reference/scim/get-a-scim-group-mapping.md
path: docs/api/api-reference/scim/get-a-scim-group-mapping
---
...
````yaml /openapi/openapi.yaml get /scim/group-mappings/{id}
openapi: 3.1.0
info:
  contact:
