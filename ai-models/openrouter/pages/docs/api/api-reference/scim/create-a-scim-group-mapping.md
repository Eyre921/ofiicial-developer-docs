---
title: "Create a SCIM group mapping"
source: https://openrouter.ai/docs/api/api-reference/scim/create-a-scim-group-mapping.md
path: docs/api/api-reference/scim/create-a-scim-group-mapping
---
