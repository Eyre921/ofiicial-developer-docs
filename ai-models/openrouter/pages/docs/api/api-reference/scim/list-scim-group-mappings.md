...
source: https://openrouter.ai/docs/api/api-reference/scim/list-scim-group-mappings.md
path: docs/api/api-reference/scim/list-scim-group-mappings
---
...
````yaml /openapi/openapi.yaml get /scim/group-mappings
openapi: 3.1.0
info:
  contact:
