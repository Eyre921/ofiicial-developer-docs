---
title: "Update a SCIM group mapping"
source: https://openrouter.ai/docs/api/api-reference/scim/update-a-scim-group-mapping.md
path: docs/api/api-reference/scim/update-a-scim-group-mapping
---
...
````yaml /openapi/openapi.yaml patch /scim/group-mappings/{id}
openapi: 3.1.0
info:
  contact:
