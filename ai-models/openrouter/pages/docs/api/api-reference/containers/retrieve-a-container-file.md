...
source: https://openrouter.ai/docs/api/api-reference/containers/retrieve-a-container-file.md
path: docs/api/api-reference/containers/retrieve-a-container-file
---
...
````yaml /openapi/openapi.yaml get /containers/{container_id}/files/{file_id}
openapi: 3.1.0
info:
  contact:
