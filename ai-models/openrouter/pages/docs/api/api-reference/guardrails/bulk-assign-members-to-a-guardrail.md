...
source: https://openrouter.ai/docs/api/api-reference/guardrails/bulk-assign-members-to-a-guardrail.md
path: docs/api/api-reference/guardrails/bulk-assign-members-to-a-guardrail
---
