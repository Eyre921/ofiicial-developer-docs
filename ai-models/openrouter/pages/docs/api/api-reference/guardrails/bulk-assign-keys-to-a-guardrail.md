...
source: https://openrouter.ai/docs/api/api-reference/guardrails/bulk-assign-keys-to-a-guardrail.md
path: docs/api/api-reference/guardrails/bulk-assign-keys-to-a-guardrail
---
