...
source: https://openrouter.ai/docs/api/api-reference/guardrails/bulk-assign-keys-to-guardrail.md
path: docs/api/api-reference/guardrails/bulk-assign-keys-to-guardrail
---
