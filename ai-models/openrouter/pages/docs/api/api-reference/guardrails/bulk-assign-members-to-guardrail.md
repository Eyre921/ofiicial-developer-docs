...
source: https://openrouter.ai/docs/api/api-reference/guardrails/bulk-assign-members-to-guardrail.md
path: docs/api/api-reference/guardrails/bulk-assign-members-to-guardrail
---
