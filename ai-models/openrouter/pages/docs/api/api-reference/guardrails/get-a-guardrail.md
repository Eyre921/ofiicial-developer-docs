...
source: https://openrouter.ai/docs/api/api-reference/guardrails/get-a-guardrail.md
path: docs/api/api-reference/guardrails/get-a-guardrail
---
...
````yaml /openapi/openapi.yaml get /guardrails/{id}
openapi: 3.1.0
info:
  contact:
