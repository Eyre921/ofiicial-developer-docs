---
title: "Submit a Decisions request"
source: https://openrouter.ai/docs/api/api-reference/alphadecisions/submit-a-decisions-request.md
path: docs/api/api-reference/alphadecisions/submit-a-decisions-request
---
