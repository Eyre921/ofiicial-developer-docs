---
title: "Delete a workspace secret"
source: https://openrouter.ai/docs/api/api-reference/vault/delete-a-workspace-secret.md
path: docs/api/api-reference/vault/delete-a-workspace-secret
---
