---
title: "Store a workspace secret"
source: https://openrouter.ai/docs/api/api-reference/vault/store-a-workspace-secret.md
path: docs/api/api-reference/vault/store-a-workspace-secret
---
