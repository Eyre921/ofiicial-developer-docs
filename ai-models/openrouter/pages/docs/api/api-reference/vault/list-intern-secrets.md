---
title: "List intern secrets"
source: https://openrouter.ai/docs/api/api-reference/vault/list-intern-secrets.md
path: docs/api/api-reference/vault/list-intern-secrets
---
