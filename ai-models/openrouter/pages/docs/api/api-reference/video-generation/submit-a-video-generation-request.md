...
source: https://openrouter.ai/docs/api/api-reference/video-generation/submit-a-video-generation-request.md
path: docs/api/api-reference/video-generation/submit-a-video-generation-request
---
