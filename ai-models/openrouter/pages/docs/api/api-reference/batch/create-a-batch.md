...
source: https://openrouter.ai/docs/api/api-reference/batch/create-a-batch.md
path: docs/api/api-reference/batch/create-a-batch
---
...
````yaml /openapi/openapi.yaml post /batches
openapi: 3.1.0
info:
  contact:
...
paths:
  /batches:
    post:
      ...
      description: >-
        Creates a batch of requests that run asynchronously against a single
        endpoint (`/v1/chat/completions`, `/v1/responses`, `/v1/messages`,
        `/v1/embeddings`). Returns `202` with `status: "validating"`. Poll `GET
        /batches/{id}` for progress and results. See the [Batch API
                ...
                value:
                  ...
                  requests:
                    - body:
                      ...
                      custom_id: req-0001
              providerPinned:
                summary: Batch pinned to Vertex
                value:
                  endpoint: /v1/chat/completions
                ...
                value:
                  ...
                  requests:
                    - body:
                      ...
                      custom_id: req-0001
            schema:
              $ref: '#/components/schemas/BatchSubmitBody'
        description: >-
          The batch to create. Each item in `requests` has a unique `custom_id`
          and a `body` in the request format of the chosen `endpoint`.
        required: true
      responses:
        '202':
          content:
          ...
          description: >-
            Batch payload durably persisted and queued for asynchronous
            validation and provider submission (`status: "validating"`).
        '400':
          content:
            application/json:
              example:
          ...
          description: Malformed batch input or an unknown/incompatible batch model.
        '401':
          content:
            application/json:
              example:
        ...
        '402':
          content:
            application/json:
              ...
              schema:
                $ref: '#/components/schemas/BatchErrorResponse'
          description: The estimated batch cost exceeds the available balance.
        '403':
          content:
            application/json:
              example:
              ...
              schema:
                $ref: '#/components/schemas/BatchErrorResponse'
          description: The resolved batch endpoint is blocked by account policy.
        '404':
          content:
            application/json:
              example:
        ...
        '413':
          content:
            application/json:
              ...
              schema:
                $ref: '#/components/schemas/BatchErrorResponse'
          description: Batch input exceeds the maximum payload size.
        '422':
          content:
            application/json:
              example:
              ...
              schema:
                $ref: '#/components/schemas/BatchErrorResponse'
          description: >-
            The requested model variant or custom IDs violate Batch API
            constraints.
        '429':
          content:
            application/json:
...
components:
  schemas:
    BatchSubmitBody:
      description: Batch submit request body.
      properties:
        completion_window:
          default: 24h
          enum:
        ...
        model:
          ...
          type: string
        provider:
          $ref: '#/components/schemas/BatchProviderPreferences'
        requests:
          items:
            properties:
              body:
                additionalProperties: true
                description: Request payload for the batch `endpoint`.
                type: object
              custom_id:
                minLength: 1
                type: string
