...
source: https://openrouter.ai/docs/api/api-reference/oauth/exchange-authorization-code-for-api-key.md
path: docs/api/api-reference/oauth/exchange-authorization-code-for-api-key
---
