...
source: https://openrouter.ai/docs/api/api-reference/interns/update-an-intern.md
path: docs/api/api-reference/interns/update-an-intern
---
  ...
  /interns/{internId}:
    patch:
      ...
      description: >-
        ...
        larger body is refused with 413. A non-empty body must declare
            ...
            application/json:
              example:
                error:
                  code: 409
                  message: >-
                    An intern named "research-assistant" already exists in this
                    workspace
                  metadata:
                    reason: name_taken
                    retryable: false
