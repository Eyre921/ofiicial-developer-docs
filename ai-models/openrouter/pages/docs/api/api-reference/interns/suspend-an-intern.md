---
title: "Suspend an intern"
source: https://openrouter.ai/docs/api/api-reference/interns/suspend-an-intern.md
path: docs/api/api-reference/interns/suspend-an-intern
---
