---
title: "Provision an intern"
source: https://openrouter.ai/docs/api/api-reference/interns/provision-an-intern.md
path: docs/api/api-reference/interns/provision-an-intern
---
