...
source: https://openrouter.ai/docs/api/api-reference/presets/create-presets-messages.md
path: docs/api/api-reference/presets/create-presets-messages
---
...
Reference: https://openrouter.ai/docs/api/api-reference/presets/create-presets-messages
...
paths:
  /presets/{slug}/messages:
    post:
      operationId: create-presets-messages
...
components:
  schemas:
    ...
    MessagesRequestToolsItems12:
      ...
      required:
        - type
      title: MessagesRequestToolsItems12
    MessagesRequestToolsItems:
      oneOf:
        ...
        - $ref: '#/components/schemas/MessagesRequestToolsItems12'
...
```python Presets_createPresetsMessages_example
import requests

url = "https://openrouter.ai/api/v1/presets/my-preset/messages"
...
```javascript Presets_createPresetsMessages_example
const url = 'https://openrouter.ai/api/v1/presets/my-preset/messages';
const options = {
  method: 'POST',
  headers: {Authorization: 'Bearer <token>', 'Content-Type': 'application/json'},
  body: '{"messages":[{"content":"Hello!","role":"user"}],"model":"anthropic/claude-4.6-sonnet","max_tokens":1024,"system":"You are a helpful assistant."}'
};
...
```go Presets_createPresetsMessages_example
package main
...
```ruby Presets_createPresetsMessages_example
require 'uri'
require 'net/http'

url = URI("https://openrouter.ai/api/v1/presets/my-preset/messages")
...
```java Presets_createPresetsMessages_example
import com.mashape.unirest.http.HttpResponse;
import com.mashape.unirest.http.Unirest;

HttpResponse<String> response = Unirest.post("https://openrouter.ai/api/v1/presets/my-preset/messages")
...
```php Presets_createPresetsMessages_example
<?php
require_once('vendor/autoload.php');

$client = new \GuzzleHttp\Client();

$response = $client->request('POST', 'https://openrouter.ai/api/v1/presets/my-preset/messages', [
  'body' => '{
  "messages": [
    {
      "content": "Hello!",
...
```csharp Presets_createPresetsMessages_example
using RestSharp;

var client = new RestClient("https://openrouter.ai/api/v1/presets/my-preset/messages");
...
```swift Presets_createPresetsMessages_example
import Foundation
...
let request = NSMutableURLRequest(url: NSURL(string: "https://openrouter.ai/api/v1/presets/my-preset/messages")! as URL,
