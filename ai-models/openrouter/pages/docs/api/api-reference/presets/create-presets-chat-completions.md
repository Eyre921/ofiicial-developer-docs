...
source: https://openrouter.ai/docs/api/api-reference/presets/create-presets-chat-completions.md
path: docs/api/api-reference/presets/create-presets-chat-completions
---
...
Reference: https://openrouter.ai/docs/api/api-reference/presets/create-presets-chat-completions
...
paths:
  /presets/{slug}/chat/completions:
    post:
      operationId: create-presets-chat-completions
...
```javascript Presets_createPresetsChatCompletions_example
const url = 'https://openrouter.ai/api/v1/presets/my-preset/chat/completions';
const options = {
  method: 'POST',
...
```go Presets_createPresetsChatCompletions_example
package main
...
```ruby Presets_createPresetsChatCompletions_example
require 'uri'
require 'net/http'

url = URI("https://openrouter.ai/api/v1/presets/my-preset/chat/completions")
...
```java Presets_createPresetsChatCompletions_example
...
```php Presets_createPresetsChatCompletions_example
<?php
require_once('vendor/autoload.php');

$client = new \GuzzleHttp\Client();

$response = $client->request('POST', 'https://openrouter.ai/api/v1/presets/my-preset/chat/completions', [
  'body' => '{
  "messages": [
    {
      "role": "system",
...
```csharp Presets_createPresetsChatCompletions_example
using RestSharp;

var client = new RestClient("https://openrouter.ai/api/v1/presets/my-preset/chat/completions");
...
```swift Presets_createPresetsChatCompletions_example
import Foundation
...
let request = NSMutableURLRequest(url: NSURL(string: "https://openrouter.ai/api/v1/presets/my-preset/chat/completions")! as URL,
