...
source: https://openrouter.ai/docs/api/api-reference/presets/create-a-preset-from-a-messages-request-body.md
path: docs/api/api-reference/presets/create-a-preset-from-a-messages-request-body
---
