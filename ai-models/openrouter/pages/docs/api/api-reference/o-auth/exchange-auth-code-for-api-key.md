...
source: https://openrouter.ai/docs/api/api-reference/o-auth/exchange-auth-code-for-api-key.md
path: docs/api/api-reference/o-auth/exchange-auth-code-for-api-key
---
