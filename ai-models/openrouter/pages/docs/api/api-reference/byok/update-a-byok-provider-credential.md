...
source: https://openrouter.ai/docs/api/api-reference/byok/update-a-byok-provider-credential.md
path: docs/api/api-reference/byok/update-a-byok-provider-credential
---
