...
source: https://openrouter.ai/docs/api/api-reference/observability/delete-observability-destination.md
path: docs/api/api-reference/observability/delete-observability-destination
---
