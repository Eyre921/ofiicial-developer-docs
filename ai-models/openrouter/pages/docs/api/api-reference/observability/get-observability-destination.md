...
source: https://openrouter.ai/docs/api/api-reference/observability/get-observability-destination.md
path: docs/api/api-reference/observability/get-observability-destination
---
