...
source: https://openrouter.ai/docs/api/api-reference/observability/create-observability-destination.md
path: docs/api/api-reference/observability/create-observability-destination
---
