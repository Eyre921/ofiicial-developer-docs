...
source: https://openrouter.ai/docs/api/api-reference/observability/update-an-observability-destination.md
path: docs/api/api-reference/observability/update-an-observability-destination
---
