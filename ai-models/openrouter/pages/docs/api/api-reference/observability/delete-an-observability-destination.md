...
source: https://openrouter.ai/docs/api/api-reference/observability/delete-an-observability-destination.md
path: docs/api/api-reference/observability/delete-an-observability-destination
---
...
````yaml /openapi/openapi.yaml delete /observability/destinations/{id}
openapi: 3.1.0
info:
  contact:
