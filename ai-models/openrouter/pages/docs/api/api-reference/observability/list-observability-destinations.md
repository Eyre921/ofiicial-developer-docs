...
source: https://openrouter.ai/docs/api/api-reference/observability/list-observability-destinations.md
path: docs/api/api-reference/observability/list-observability-destinations
---
