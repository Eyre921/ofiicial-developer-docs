...
source: https://openrouter.ai/docs/api/api-reference/observability/get-an-observability-destination.md
path: docs/api/api-reference/observability/get-an-observability-destination
---
...
````yaml /openapi/openapi.yaml get /observability/destinations/{id}
openapi: 3.1.0
info:
  contact:
