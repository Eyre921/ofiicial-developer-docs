...
source: https://openrouter.ai/docs/api/api-reference/observability/update-observability-destination.md
path: docs/api/api-reference/observability/update-observability-destination
---
