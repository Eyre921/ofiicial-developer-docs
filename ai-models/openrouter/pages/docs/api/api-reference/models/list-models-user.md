...
source: https://openrouter.ai/docs/api/api-reference/models/list-models-user.md
path: docs/api/api-reference/models/list-models-user
---
...
```go Models_listModelsUser_example
package main
...
```ruby Models_listModelsUser_example
require 'uri'
require 'net/http'
...
```java Models_listModelsUser_example
...
```php Models_listModelsUser_example
<?php
...
```swift Models_listModelsUser_example
import Foundation
