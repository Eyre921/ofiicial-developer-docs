...
source: https://openrouter.ai/docs/api/api-reference/models/list-all-models-and-their-properties.md
path: docs/api/api-reference/models/list-all-models-and-their-properties
---
