...
source: https://openrouter.ai/docs/api/api-reference/models/get-total-count-of-available-models.md
path: docs/api/api-reference/models/get-total-count-of-available-models
---
