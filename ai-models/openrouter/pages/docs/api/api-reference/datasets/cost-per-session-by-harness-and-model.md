...
source: https://openrouter.ai/docs/api/api-reference/datasets/cost-per-session-by-harness-and-model.md
path: docs/api/api-reference/datasets/cost-per-session-by-harness-and-model
---
