...
source: https://openrouter.ai/docs/api/api-reference/providers/list-providers.md
path: docs/api/api-reference/providers/list-providers
---
...
```go Providers_listProviders_example
package main
...
```ruby Providers_listProviders_example
require 'uri'
require 'net/http'
...
```java Providers_listProviders_example
...
```php Providers_listProviders_example
<?php
...
```swift Providers_listProviders_example
import Foundation
