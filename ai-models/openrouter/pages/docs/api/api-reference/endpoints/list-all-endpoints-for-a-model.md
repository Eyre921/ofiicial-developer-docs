...
source: https://openrouter.ai/docs/api/api-reference/endpoints/list-all-endpoints-for-a-model.md
path: docs/api/api-reference/endpoints/list-all-endpoints-for-a-model
---
