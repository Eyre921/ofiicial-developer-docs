...
| `model`                    | *Optional\[str]*                                                                     | :heavy\_minus\_sign: | Accepted for OpenAI compatibility and ignored. Streamed chunks report the model the intern actually used, or `openrouter/intern` when it did not report one.                                                                                                                                                                                                                                                                                                                                                                                 | openrouter/intern                    |
