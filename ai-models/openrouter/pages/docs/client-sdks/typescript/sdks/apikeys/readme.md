---
title: "APIKeys"
source: https://openrouter.ai/docs/client-sdks/typescript/sdks/apikeys/README.md
path: docs/client-sdks/typescript/sdks/apikeys/readme
---
...
Delete an existing API key. Authenticate with a [management key](/docs/client-sdks/typescript/docs/guides/overview/auth/management-api-keys).
...
Update an existing API key. Authenticate with a [management key](/docs/client-sdks/typescript/docs/guides/overview/auth/management-api-keys).
