...
source: https://openrouter.ai/docs/client-sdks/typescript/sdks/classifications/README.md
path: docs/client-sdks/typescript/sdks/classifications/readme
---
...
| ---------------------- | ----------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.GetTaskClassificationsRequest](../../models/operations/gettaskclassificationsrequest.mdx) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |
