...
source: https://openrouter.ai/docs/cookbook/evaluate-and-optimize/model-migrations/fable-5-1.md
path: docs/cookbook/evaluate-and-optimize/model-migrations/fable-5-1
---
...
> Migrate to Claude Fable 5.1 — prefix-locked thinking, ephemeral system messages, per-turn effort, forced tool use rejected, and mid-thinking display updates
