...
source: https://openrouter.ai/docs/cookbook/evaluate-and-optimize/model-migrations/claude-4-6.md
path: docs/cookbook/evaluate-and-optimize/model-migrations/claude-4-6
---
