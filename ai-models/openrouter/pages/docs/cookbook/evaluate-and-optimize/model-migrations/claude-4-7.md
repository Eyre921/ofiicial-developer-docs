...
source: https://openrouter.ai/docs/cookbook/evaluate-and-optimize/model-migrations/claude-4-7.md
path: docs/cookbook/evaluate-and-optimize/model-migrations/claude-4-7
---
