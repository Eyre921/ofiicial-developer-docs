...
source: https://openrouter.ai/docs/guides/best-practices/reasoning-tokens.md
path: docs/guides/best-practices/reasoning-tokens
---
...
<span id="anthropic-messages-api" />
