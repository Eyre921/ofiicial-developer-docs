...
source: https://openrouter.ai/docs/guides/overview/multimodal/overview.md
path: docs/guides/overview/multimodal/overview
---
...
> Send images, PDFs, audio, and video to OpenRouter models, generate speech from text, or transcribe audio to text
