---
title: "Presets"
source: https://openrouter.ai/docs/guides/features/presets.md
path: docs/guides/features/presets
---
...
1. [Create a preset](/settings/presets). For example, select a model and restrict provider routing to just a few providers.
   ![Creating a new preset](file:253f15c5-9545-41fb-a674-7f603910e283 "A new preset")
