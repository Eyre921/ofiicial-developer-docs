...
source: https://openrouter.ai/docs/guides/community/typesafe-sdk.md
path: docs/guides/community/typesafe-sdk
---
...
* [Jev documentation hub](/docs/guides/community/jev) for what Jev is, how it differs from a chat model, and every Jev page on OpenRouter
...
* [Classify and Tag Text at Scale with Jev](/docs/cookbook/evaluate-and-optimize/jev-classification) for batch labeling with Choice categories and Noul tags
* [Classify Reddit and YouTube Comments with Jev](/docs/cookbook/evaluate-and-optimize/classify-reddit-comments-with-jev) for scoring scraped comments on relevance and sentiment
* [Auto-Approve Coding Agent Permission Prompts with Jev](/docs/cookbook/coding-agents/auto-approve-permission-prompts-with-jev) for answering Claude Code, Codex, Cursor, and OpenCode permission prompts with a Noul threshold
