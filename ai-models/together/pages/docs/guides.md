...
<GridGuides>
  <GuideCard title="Agent Workflows" description="Orchestrating multiple language model calls to solve complex tasks." href="/docs/workflows" />
...
<GridGuides>
  ...
  <GuideCard title="Logprobs" description="Understanding and using log probabilities in language models." href="/docs/inference/chat/logprobs" />
