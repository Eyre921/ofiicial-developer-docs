...
export const generateAnalysisCode = (
  ...
  csvHeaders: string[],
  csvRows: { [key: string]: string }[],
  model: string = "moonshotai/Kimi-K2.7-Code",
) => {
...
* [**Kimi K2.7 Code**](https://api.together.ai/models/moonshotai/Kimi-K2.7-Code) (default): Fast, reliable code generation.
* [**DeepSeek-V4-Pro**](https://api.together.ai/models/deepseek-ai/DeepSeek-V4-Pro): Complex analysis tasks that benefit from more reasoning.
