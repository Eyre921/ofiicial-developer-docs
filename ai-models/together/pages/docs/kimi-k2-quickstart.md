...
path: docs/kimi-k2-quickstart
---

How to get the most out of models like Kimi K2.

<Tip>
  Kimi K2-Instruct-0905 has been deprecated. We recommend using [Kimi K2.6](/docs/kimi-k2.6-quickstart) (`moonshotai/Kimi-K2.6`) in Instruct mode instead.
</Tip>
