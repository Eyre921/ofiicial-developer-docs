...
path: docs/data-analyst-agent
---

Build an AI data analyst with code interpreter, E2B, and Together AI.
...
# TODO: Get your Together AI API key from https://api.together.ai/settings/projects/~current/api-keys
