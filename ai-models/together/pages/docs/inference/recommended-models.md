...
| **Reasoning**                | Kimi K3           | `moonshotai/Kimi-K3`                 | `deepseek-ai/DeepSeek-V4-Pro`                                    | [Reasoning](/docs/inference/chat/reasoning)                   |
| **Coding agents**            | Kimi K3           | `moonshotai/Kimi-K3`                 | `deepseek-ai/DeepSeek-V4-Flash-0731`, `zai-org/GLM-5.2`          | [Build coding agents](/docs/how-to-build-coding-agents)       |
...
| **Function calling**         | DeepSeek V4 Flash | `deepseek-ai/DeepSeek-V4-Flash-0731` | `zai-org/GLM-5.2`                                                | [Function calling](/docs/inference/function-calling/overview) |
