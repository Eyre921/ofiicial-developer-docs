---
title: "Run a model"
source: https://replicate.com/docs/topics/models/run-a-model.md
path: docs/topics/models/run-a-model
---
...
![Replicate's web playground UI for running models in the browser](/_content/assets/playground.BHdwmyKJ.png)
