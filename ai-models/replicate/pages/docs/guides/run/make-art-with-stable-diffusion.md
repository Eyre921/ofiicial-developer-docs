---
title: "Make art with Stable Diffusion"
source: https://replicate.com/docs/guides/run/make-art-with-stable-diffusion.md
path: docs/guides/run/make-art-with-stable-diffusion
---
...
In the example image below, there’s a checkboard pattern to indicate the “transparent” parts of the canvas that will be outpainted, but the checkboard is not actually necessary. You can choose any color you like for the surrounding canvas, but it’s a good idea to choose a color that’s similar to the color of the image you’re outpainting. This will help the model generate a more seamless transition between the original image and the outpainted region.
...
![lincoln](/_content/assets/lincoln.B_T-CDxl_3dB7i.webp)
...
![diagram](/_content/assets/nutshell.DqntBMaM_XlclW.webp)
...
![types](/_content/assets/types.BGnrelYA_Z1GiEgU.webp)
...
portrait
```![couple](/_content/assets/couple.CUq7Hebg_ZyrIIL.webp)
...
```![tea](/_content/assets/tearoom.BeWNEgSh_ZaEcgq.webp)
...
![process](/_content/assets/process.L7NRtQ78_1T6Lu1.webp)
...
![tearoom](/_content/assets/tearoom.BeWNEgSh_ZaEcgq.webp) ![canny](/_content/assets/canny.DiGJ91o__vmTOj.webp)
...
![result](/_content/assets/canny-room.Bbt5HfEi_Z1nMkKk.webp)

Here’s that same process applied to our image of the couple, with our new prompt:

![couple1](/_content/assets/canny-couple.bf-Ff1mD_1dqgQh.webp)

### [](#hed--fuzzy-edge-detection)HED — Fuzzy edge detection

HED is another kind of edge detector. Here’s our pre-processed output:

![tearoom](/_content/assets/tearoom.BeWNEgSh_ZaEcgq.webp) ![hed-room](/_content/assets/hed-room.C84OzAVN_Z143XN8.webp)

And here’s our output:

![hed-room output](/_content/assets/hed-room-output.DZbswgIp_Z1W7VJT.webp)

The effect of HED is a bit more clear on our cyberpunk couple:

![hed couple](/_content/assets/hed-couple.BfeTAiv0_1DWh2W.webp)
...
![tea3](/_content/assets/mlsd-room.CKA_-Wpq_Z1N1j0t.webp) ![mlsd](/_content/assets/mlsd-room-output.CHdxIaXR_1jQewR.webp)

And on our cyberpunk couple:

![mlsd-couple](/_content/assets/mlsd-couple.YgeajmUQ_2eKThW.webp)
...
![tearoom](/_content/assets/tearoom.BeWNEgSh_ZaEcgq.webp) ![depth room](/_content/assets/depth-room.BBSKFrm1_Z18Qnsd.webp) ![depth room output](/_content/assets/depth-room-output.B0SB0kqg_VQMlJ.webp)

This works really well on our tea room. The frames, plants, tables and pillows are all preserved. Let’s try it on our couple:

![depth couple](/_content/assets/depth-couple.NTK9TfgC_191FXV.webp)
...
![pose couple](/_content/assets/pose-couple.7raBk7oW_Z1whOk6.webp)
...
![cat](/_content/assets/scribble-cat.fPhIt3dB_dm4mE.webp)

Here’s the same with an owl:

![owl](/_content/assets/scribble-owl.C9cn8DWQ_LecrA.webp)

### [](#segmentation)Segmentation

Segmentation breaks our image down into different segments.

![tearoom](/_content/assets/tearoom.BeWNEgSh_ZaEcgq.webp) ![segment room](/_content/assets/segment-room.z3VArVVw_Z1pQz8z.webp) ![segment room output](/_content/assets/segment-room-output.D-yTtXgB_2e38QD.webp)
...
![segment couple](/_content/assets/segment-couple.BeLvaZIK_2LXzB.webp)

### [](#normal-map)Normal map

A normal map detects the texture of an image.

![tearoom](/_content/assets/tearoom.BeWNEgSh_ZaEcgq.webp) ![segment room](/_content/assets/map-room.BbOILJfm_Z11mYwT.webp) ![segment room output](/_content/assets/map-room-output.B9i38Zm0_1KJgac.webp)

This is a nice output, but it doesn’t preserve our original input at all. A normal map works much better on our couple:

![segment room output](/_content/assets/map-couple.ByfbOOLS_Z1xb819.webp)
...
![collection](/_content/assets/collection.B5UBGUsL_Zk4qXQ.webp)
...
![gui](/_content/assets/canny-gui.Dvn3c8Ko_Z1V1WRz.webp)
