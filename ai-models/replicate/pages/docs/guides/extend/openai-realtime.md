---
title: "Build a realtime speech app with OpenAI, Cloudflare, and Replicate"
source: https://replicate.com/docs/guides/extend/openai-realtime.md
path: docs/guides/extend/openai-realtime
---
