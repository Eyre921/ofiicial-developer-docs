---
title: "Push a Diffusers model"
source: https://replicate.com/docs/guides/build/push-a-diffusers-model.md
path: docs/guides/build/push-a-diffusers-model
---
...
This will run the model locally and return the output image. You can change the prompt, width, Learn how to push a [Diffusers](https://huggingface.co/docs/diffusers) image generation model to Replicate as a scalable API.
