---
title: "Set up a CI/CD pipeline for your model"
source: https://replicate.com/docs/guides/build/continuous-model-deployment.md
path: docs/guides/build/continuous-model-deployment
---
