---
title: "Fine-tune an image model"
source: https://replicate.com/docs/get-started/fine-tune-with-flux.md
path: docs/get-started/fine-tune-with-flux
---
...
[![Variants of 'ZIKI on a skateboard', generated by the ziki-flux fine-tune.](/_content/assets/variants-of-ziki.4nAvCemG_Z1HgsMB.webp)](https://replicate.com/zeke/ziki-flux)
...
![Variety is key. For best results, choose training images with different settings, clothing, lighting, and angles. Look at all these Zekes!](/_content/assets/ziki-training-data.B_DumIHc_Z1s72Xh.webp)
...
![Your fine-tuned FLUX model can public or private.](/_content/assets/new-model-destination.B2izufTx_Z1XjpIv.webp)
...
![Run your new fine-tuned model from the Replicate web playground.](/_content/assets/ziki-web-playground.BAM8CA5y_Z2fMAGf.webp)
...
![Run your new fine-tuned model with Node.js](/_content/assets/ziki-web-playground-node.BgqVxisR_FJ5Mu.webp)
