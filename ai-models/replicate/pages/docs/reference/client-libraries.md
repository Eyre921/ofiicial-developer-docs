...
source: https://replicate.com/docs/reference/client-libraries.md
path: docs/reference/client-libraries
---
...
*   [mcp.replicate.com](https://mcp.replicate.com) – MCP client for Replicate’s HTTP API
